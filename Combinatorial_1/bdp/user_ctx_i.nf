...
THEORY ListConstantsX IS
  List_Valuable_Constants(Implementation(user_ctx_i))==(?);
  Inherited_List_Constants(Implementation(user_ctx_i))==(?);
...
THEORY ListPropertiesX IS
  Abstract_List_Properties(Implementation(user_ctx_i))==(btrue);
...
THEORY ListValuesX IS
  Values_Subs(Implementation(user_ctx_i))==(aa: aa);
  List_Values(Implementation(user_ctx_i))==(?)
END
&
