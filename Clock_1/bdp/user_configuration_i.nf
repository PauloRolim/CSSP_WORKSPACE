...
THEORY ListValuesX IS
  ...
  Values_Subs(Implementation(user_configuration_i))==(NB_MODULES,NB_INPUTS,NB_OUTPUTS,module_secu_ids,module_nb_inputs,module_nb_outputs,input_module_ids,input_local_ids,output_module_ids,output_local_ids: 1,0,2,{0|->986880},{0|->3},{0|->2},{0|->255,1|->255,2|->255},{0|->255,1|->255,2|->255},{0|->0,1|->0},{0|->0,1|->1});
  List_Values(Implementation(user_configuration_i))==(NB_MODULES = 1;NB_INPUTS = 0;NB_OUTPUTS = 2;module_secu_ids = {0|->986880};module_nb_inputs = {0|->3};module_nb_outputs = {0|->2};input_module_ids = {0|->255,1|->255,2|->255};input_local_ids = {0|->255,1|->255,2|->255};output_module_ids = {0|->0,1|->0};output_local_ids = {0|->0,1|->1})
END
&
