...
THEORY ListVariablesX IS
  ...
  Abstract_List_Variables(Implementation(inputs_i))==(?);
...
THEORY ListVisibleVariablesX IS
  ...
  List_VisibleVariables(Implementation(inputs_i))==(?);
  Internal_List_VisibleVariables(Implementation(inputs_i))==(?)
END
&
THEORY ListInvariantX IS
  Gluing_Seen_List_Invariant(Implementation(inputs_i))==(btrue);
  Expanded_List_Invariant(Implementation(inputs_i))==(btrue);
  Abstract_List_Invariant(Implementation(inputs_i))==(btrue);
  Context_List_Invariant(Implementation(inputs_i))==(ms_tick: uint32_t);
  List_Invariant(Implementation(inputs_i))==(btrue)
END
&
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Implementation(inputs_i))==(skip);
  Context_List_Initialisation(Implementation(inputs_i))==(skip);
  List_Initialisation(Implementation(inputs_i))==(skip)
END
&
...
THEORY ListOperationsX IS
  Internal_List_Operations(Implementation(inputs_i))==(?);
  List_Operations(Implementation(inputs_i))==(?)
END
&
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(inputs_i)) == (? | ? | ? | ? | ? | ? | seen(Machine(g_types)),seen(Machine(io_constants)),seen(Machine(lchip_configuration)),seen(Machine(lchip_interface)) | ? | inputs_i);
  List_Of_HiddenCst_Ids(Implementation(inputs_i)) == (? | ?);
  List_Of_VisibleCst_Ids(Implementation(inputs_i)) == (?);
  List_Of_VisibleVar_Ids(Implementation(inputs_i)) == (? | ?);
...
THEORY TypingPredicateX IS
  TypingPredicate(Implementation(inputs_i))==(btrue)
END
&
