...
THEORY ListSeenInfoX IS
  ...
  Seen_Expanded_List_Substitution(Implementation(outputs_i),user_logic)==(@(board_0_O1$1,board_0_O2$1).(board_0_O1$1: uint8_t & board_0_O2$1: uint8_t & not(board_0_O1$1 = board_0_O2$1) ==> board_0_O1,board_0_O2:=board_0_O1$1,board_0_O2$1));
