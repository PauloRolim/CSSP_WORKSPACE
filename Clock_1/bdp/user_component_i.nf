...
THEORY ListIncludesX IS
  List_Includes(Implementation(user_component_i))==(user_ctx,logic,outputs);
  Inherited_List_Includes(Implementation(user_component_i))==(outputs,logic,user_ctx)
END
&
...
THEORY ListVariablesX IS
  ...
  List_Variables(Implementation(user_component_i))==(board_0_O2,board_0_O1);
  External_List_Variables(Implementation(user_component_i))==(board_0_O2,board_0_O1)
END
&
...
THEORY ListInvariantX IS
  ...
  Expanded_List_Invariant(Implementation(user_component_i))==(board_0_O1: uint8_t & board_0_O2: uint8_t);
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Implementation(user_component_i))==(@(board_0_O1$0).(board_0_O1$0: uint8_t ==> board_0_O1:=board_0_O1$0) || @(board_0_O2$0).(board_0_O2$0: uint8_t ==> board_0_O2:=board_0_O2$0);(0: INT | divergence_test_var:=0));
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(user_component_i),user_app)==(btrue | (0: INT | divergence_test_var:=0);(btrue | @(board_0_O1$1,board_0_O2$1).(board_0_O1$1: uint8_t & board_0_O2$1: uint8_t & not(board_0_O1$1 = board_0_O2$1) ==> board_0_O1,board_0_O2:=board_0_O1$1,board_0_O2$1));(btrue | skip));
  List_Substitution(Implementation(user_component_i),user_app)==(divergence_test_var:=0;user_logic;write_outputs);
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(user_component_i)) == (? | delta_t,delta_t1 | ? | board_0_O2,board_0_O1 | user_app,user_consistency_error_detection_test | ? | seen(Machine(g_types)),imported(Machine(user_ctx)),imported(Machine(logic)),imported(Machine(outputs)) | ? | user_component_i);
