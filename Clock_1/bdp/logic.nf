...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(logic),user_logic)==(btrue | @(board_0_O1$1,board_0_O2$1).(board_0_O1$1: uint8_t & board_0_O2$1: uint8_t & not(board_0_O1$1 = board_0_O2$1) ==> board_0_O1,board_0_O2:=board_0_O1$1,board_0_O2$1));
  List_Substitution(Machine(logic),user_logic)==(board_0_O1,board_0_O2: (board_0_O1: uint8_t & board_0_O2: uint8_t & not(board_0_O1 = board_0_O2)));
