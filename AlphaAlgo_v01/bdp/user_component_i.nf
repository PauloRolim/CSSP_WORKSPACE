...
THEORY ListVariablesX IS
  ...
  List_Variables(Implementation(user_component_i))==(i_Comm_asnwer,i_Detection_neighbours,i_Obstacle_position_l,i_Obstacle_position_r,o_Comm_question,o_Movement_move_av_3,o_Movement_move_av_2,o_Movement_move_av_1,o_Movement_move_lv_3,o_Movement_move_lv_2,o_Movement_move_lv_1,o_Movement_move);
  External_List_Variables(Implementation(user_component_i))==(i_Comm_asnwer,i_Detection_neighbours,i_Obstacle_position_l,i_Obstacle_position_r,o_Comm_question,o_Movement_move_av_3,o_Movement_move_av_2,o_Movement_move_av_1,o_Movement_move_lv_3,o_Movement_move_lv_2,o_Movement_move_lv_1,o_Movement_move)
END
&
...
THEORY ListInvariantX IS
  ...
  Expanded_List_Invariant(Implementation(user_component_i))==(i_Obstacle_position_r: uint8_t & i_Obstacle_position_l: uint8_t & i_Detection_neighbours: uint8_t & i_Comm_asnwer: uint8_t & o_Movement_move: uint8_t & o_Movement_move_lv_1: uint8_t & o_Movement_move_lv_2: uint8_t & o_Movement_move_lv_3: uint8_t & o_Movement_move_av_1: uint8_t & o_Movement_move_av_2: uint8_t & o_Movement_move_av_3: uint8_t & o_Comm_question: uint8_t);
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Implementation(user_component_i))==(@(i_Obstacle_position_r$0).(i_Obstacle_position_r$0: uint8_t ==> i_Obstacle_position_r:=i_Obstacle_position_r$0) || @(i_Obstacle_position_l$0).(i_Obstacle_position_l$0: uint8_t ==> i_Obstacle_position_l:=i_Obstacle_position_l$0) || @(i_Detection_neighbours$0).(i_Detection_neighbours$0: uint8_t ==> i_Detection_neighbours:=i_Detection_neighbours$0) || @(i_Comm_asnwer$0).(i_Comm_asnwer$0: uint8_t ==> i_Comm_asnwer:=i_Comm_asnwer$0);(@(o_Movement_move$0).(o_Movement_move$0: uint8_t ==> o_Movement_move:=o_Movement_move$0) || @(o_Movement_move_lv_1$0).(o_Movement_move_lv_1$0: uint8_t ==> o_Movement_move_lv_1:=o_Movement_move_lv_1$0) || @(o_Movement_move_lv_2$0).(o_Movement_move_lv_2$0: uint8_t ==> o_Movement_move_lv_2:=o_Movement_move_lv_2$0) || @(o_Movement_move_lv_3$0).(o_Movement_move_lv_3$0: uint8_t ==> o_Movement_move_lv_3:=o_Movement_move_lv_3$0) || @(o_Movement_move_av_1$0).(o_Movement_move_av_1$0: uint8_t ==> o_Movement_move_av_1:=o_Movement_move_av_1$0) || @(o_Movement_move_av_2$0).(o_Movement_move_av_2$0: uint8_t ==> o_Movement_move_av_2:=o_Movement_move_av_2$0) || @(o_Movement_move_av_3$0).(o_Movement_move_av_3$0: uint8_t ==> o_Movement_move_av_3:=o_Movement_move_av_3$0) || @(o_Comm_question$0).(o_Comm_question$0: uint8_t ==> o_Comm_question:=o_Comm_question$0));(0: INT | divergence_test_var:=0));
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(user_component_i),user_app)==(btrue | (0: INT | divergence_test_var:=0);(btrue | @(i_Obstacle_position_r$0).(i_Obstacle_position_r$0: uint8_t ==> i_Obstacle_position_r:=i_Obstacle_position_r$0) || @(i_Obstacle_position_l$0).(i_Obstacle_position_l$0: uint8_t ==> i_Obstacle_position_l:=i_Obstacle_position_l$0) || @(i_Detection_neighbours$0).(i_Detection_neighbours$0: uint8_t ==> i_Detection_neighbours:=i_Detection_neighbours$0) || @(i_Comm_asnwer$0).(i_Comm_asnwer$0: uint8_t ==> i_Comm_asnwer:=i_Comm_asnwer$0));(btrue | @(o_Movement_move$0).(o_Movement_move$0: uint8_t ==> o_Movement_move:=o_Movement_move$0) || @(o_Movement_move_lv_1$0).(o_Movement_move_lv_1$0: uint8_t ==> o_Movement_move_lv_1:=o_Movement_move_lv_1$0) || @(o_Movement_move_lv_2$0).(o_Movement_move_lv_2$0: uint8_t ==> o_Movement_move_lv_2:=o_Movement_move_lv_2$0) || @(o_Movement_move_lv_3$0).(o_Movement_move_lv_3$0: uint8_t ==> o_Movement_move_lv_3:=o_Movement_move_lv_3$0) || @(o_Movement_move_av_1$0).(o_Movement_move_av_1$0: uint8_t ==> o_Movement_move_av_1:=o_Movement_move_av_1$0) || @(o_Movement_move_av_2$0).(o_Movement_move_av_2$0: uint8_t ==> o_Movement_move_av_2:=o_Movement_move_av_2$0) || @(o_Movement_move_av_3$0).(o_Movement_move_av_3$0: uint8_t ==> o_Movement_move_av_3:=o_Movement_move_av_3$0) || @(o_Comm_question$0).(o_Comm_question$0: uint8_t ==> o_Comm_question:=o_Comm_question$0));(btrue | skip));
...
THEORY ListIncludedOperationsX IS
  ...
  List_Included_Operations(Implementation(user_component_i),Machine(logic))==(user_logic,get_o_Movement_move,get_o_Movement_move_lv_1,get_o_Movement_move_lv_2,get_o_Movement_move_lv_3,get_o_Movement_move_av_1,get_o_Movement_move_av_2,get_o_Movement_move_av_3,get_o_Comm_question);
  List_Included_Operations(Implementation(user_component_i),Machine(inputs))==(read_inputs,get_i_Obstacle_position_r,get_i_Obstacle_position_l,get_i_Detection_neighbours,get_i_Comm_asnwer)
END
&
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(user_component_i)) == (? | cycle_unit,SimSMovement_cycle_def,av,lv,pi,STATE,INIT,EXEC_1,EXEC_2 | ? | o_Comm_question,o_Movement_move_av_3,o_Movement_move_av_2,o_Movement_move_av_1,o_Movement_move_lv_3,o_Movement_move_lv_2,o_Movement_move_lv_1,o_Movement_move,i_Comm_asnwer,i_Detection_neighbours,i_Obstacle_position_l,i_Obstacle_position_r | user_app,user_consistency_error_detection_test | ? | seen(Machine(g_types)),imported(Machine(user_ctx)),imported(Machine(inputs)),imported(Machine(logic)),imported(Machine(outputs)) | ? | user_component_i);
...
THEORY ImportedVariablesListX IS
  ...
  ImportedVariablesList(Implementation(user_component_i),Machine(inputs))==(i_Comm_asnwer,i_Detection_neighbours,i_Obstacle_position_l,i_Obstacle_position_r);
  ImportedVisVariablesList(Implementation(user_component_i),Machine(inputs))==(?);
  ImportedVariablesList(Implementation(user_component_i),Machine(logic))==(o_Comm_question,o_Movement_move_av_3,o_Movement_move_av_2,o_Movement_move_av_1,o_Movement_move_lv_3,o_Movement_move_lv_2,o_Movement_move_lv_1,o_Movement_move);
