...
THEORY ListInvariantX IS
  ...
  Context_List_Invariant(Implementation(outputs_i))==(ms_tick: uint32_t & o_Movement_move: uint8_t & o_Movement_move_lv_1: uint8_t & o_Movement_move_lv_2: uint8_t & o_Movement_move_lv_3: uint8_t & o_Movement_move_av_1: uint8_t & o_Movement_move_av_2: uint8_t & o_Movement_move_av_3: uint8_t & o_Comm_question: uint8_t);
...
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Implementation(outputs_i),write_outputs)==(btrue | @lsb.(@(lsb$2).(lsb$2: uint8_t ==> lsb:=lsb$2);(lsb: uint8_t | lsb:=o_Movement_move);(0: uint8_t & 0<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_Movement_move_lv_1);(1: uint8_t & 1<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_Movement_move_lv_2);(2: uint8_t & 2<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_Movement_move_lv_3);(3: uint8_t & 3<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_Movement_move_av_1);(4: uint8_t & 4<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_Movement_move_av_2);(5: uint8_t & 5<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_Movement_move_av_3);(6: uint8_t & 6<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_Comm_question);(7: uint8_t & 7<MAX_NB_OUTPUTS & lsb: uint8_t | skip)));
  List_Substitution(Implementation(outputs_i),write_outputs)==(VAR lsb IN lsb: (lsb: uint8_t);lsb <-- get_o_Movement_move;write_global_output(0,lsb);lsb <-- get_o_Movement_move_lv_1;write_global_output(1,lsb);lsb <-- get_o_Movement_move_lv_2;write_global_output(2,lsb);lsb <-- get_o_Movement_move_lv_3;write_global_output(3,lsb);lsb <-- get_o_Movement_move_av_1;write_global_output(4,lsb);lsb <-- get_o_Movement_move_av_2;write_global_output(5,lsb);lsb <-- get_o_Movement_move_av_3;write_global_output(6,lsb);lsb <-- get_o_Comm_question;write_global_output(7,lsb) END)
END
&
...
THEORY ListSeenInfoX IS
  Seen_Internal_List_Operations(Implementation(outputs_i),Machine(logic))==(user_logic,get_o_Movement_move,get_o_Movement_move_lv_1,get_o_Movement_move_lv_2,get_o_Movement_move_lv_3,get_o_Movement_move_av_1,get_o_Movement_move_av_2,get_o_Movement_move_av_3,get_o_Comm_question);
...
THEORY ListIncludedOperationsX IS
  List_Included_Operations(Implementation(outputs_i),Machine(logic))==(user_logic,get_o_Movement_move,get_o_Movement_move_lv_1,get_o_Movement_move_lv_2,get_o_Movement_move_lv_3,get_o_Movement_move_av_1,get_o_Movement_move_av_2,get_o_Movement_move_av_3,get_o_Comm_question);
