...
THEORY ListVariablesX IS
  ...
  Local_List_Variables(Machine(logic))==(o_Comm_question,o_Movement_move_av_3,o_Movement_move_av_2,o_Movement_move_av_1,o_Movement_move_lv_3,o_Movement_move_lv_2,o_Movement_move_lv_1,o_Movement_move);
  List_Variables(Machine(logic))==(o_Comm_question,o_Movement_move_av_3,o_Movement_move_av_2,o_Movement_move_av_1,o_Movement_move_lv_3,o_Movement_move_lv_2,o_Movement_move_lv_1,o_Movement_move);
  External_List_Variables(Machine(logic))==(o_Comm_question,o_Movement_move_av_3,o_Movement_move_av_2,o_Movement_move_av_1,o_Movement_move_lv_3,o_Movement_move_lv_2,o_Movement_move_lv_1,o_Movement_move)
END
&
...
THEORY ListInvariantX IS
  ...
  List_Invariant(Machine(logic))==(o_Movement_move: uint8_t & o_Movement_move_lv_1: uint8_t & o_Movement_move_lv_2: uint8_t & o_Movement_move_lv_3: uint8_t & o_Movement_move_av_1: uint8_t & o_Movement_move_av_2: uint8_t & o_Movement_move_av_3: uint8_t & o_Comm_question: uint8_t)
END
&
...
THEORY ListOperationsX IS
  Internal_List_Operations(Machine(logic))==(user_logic,get_o_Movement_move,get_o_Movement_move_lv_1,get_o_Movement_move_lv_2,get_o_Movement_move_lv_3,get_o_Movement_move_av_1,get_o_Movement_move_av_2,get_o_Movement_move_av_3,get_o_Comm_question);
  List_Operations(Machine(logic))==(user_logic,get_o_Movement_move,get_o_Movement_move_lv_1,get_o_Movement_move_lv_2,get_o_Movement_move_lv_3,get_o_Movement_move_av_1,get_o_Movement_move_av_2,get_o_Movement_move_av_3,get_o_Comm_question)
END
&
THEORY ListInputX IS
  List_Input(Machine(logic),user_logic)==(?);
  List_Input(Machine(logic),get_o_Movement_move)==(?);
  List_Input(Machine(logic),get_o_Movement_move_lv_1)==(?);
  List_Input(Machine(logic),get_o_Movement_move_lv_2)==(?);
  List_Input(Machine(logic),get_o_Movement_move_lv_3)==(?);
  List_Input(Machine(logic),get_o_Movement_move_av_1)==(?);
  List_Input(Machine(logic),get_o_Movement_move_av_2)==(?);
  List_Input(Machine(logic),get_o_Movement_move_av_3)==(?);
  List_Input(Machine(logic),get_o_Comm_question)==(?)
END
&
THEORY ListOutputX IS
  List_Output(Machine(logic),user_logic)==(?);
  List_Output(Machine(logic),get_o_Movement_move)==(po);
  List_Output(Machine(logic),get_o_Movement_move_lv_1)==(po);
  List_Output(Machine(logic),get_o_Movement_move_lv_2)==(po);
  List_Output(Machine(logic),get_o_Movement_move_lv_3)==(po);
  List_Output(Machine(logic),get_o_Movement_move_av_1)==(po);
  List_Output(Machine(logic),get_o_Movement_move_av_2)==(po);
  List_Output(Machine(logic),get_o_Movement_move_av_3)==(po);
  List_Output(Machine(logic),get_o_Comm_question)==(po)
END
&
THEORY ListHeaderX IS
  List_Header(Machine(logic),user_logic)==(user_logic);
  List_Header(Machine(logic),get_o_Movement_move)==(po <-- get_o_Movement_move);
  List_Header(Machine(logic),get_o_Movement_move_lv_1)==(po <-- get_o_Movement_move_lv_1);
  List_Header(Machine(logic),get_o_Movement_move_lv_2)==(po <-- get_o_Movement_move_lv_2);
  List_Header(Machine(logic),get_o_Movement_move_lv_3)==(po <-- get_o_Movement_move_lv_3);
  List_Header(Machine(logic),get_o_Movement_move_av_1)==(po <-- get_o_Movement_move_av_1);
  List_Header(Machine(logic),get_o_Movement_move_av_2)==(po <-- get_o_Movement_move_av_2);
  List_Header(Machine(logic),get_o_Movement_move_av_3)==(po <-- get_o_Movement_move_av_3);
  List_Header(Machine(logic),get_o_Comm_question)==(po <-- get_o_Comm_question)
END
&
...
THEORY ListPreconditionX IS
  ...
  List_Precondition(Machine(logic),get_o_Movement_move)==(po: uint8_t);
  List_Precondition(Machine(logic),get_o_Movement_move_lv_1)==(po: uint8_t);
  List_Precondition(Machine(logic),get_o_Movement_move_lv_2)==(po: uint8_t);
  List_Precondition(Machine(logic),get_o_Movement_move_lv_3)==(po: uint8_t);
  List_Precondition(Machine(logic),get_o_Movement_move_av_1)==(po: uint8_t);
  List_Precondition(Machine(logic),get_o_Movement_move_av_2)==(po: uint8_t);
  List_Precondition(Machine(logic),get_o_Movement_move_av_3)==(po: uint8_t);
  List_Precondition(Machine(logic),get_o_Comm_question)==(po: uint8_t)
END
&
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Machine(logic),get_o_Comm_question)==(po: uint8_t | po:=o_Comm_question);
  Expanded_List_Substitution(Machine(logic),get_o_Movement_move_av_3)==(po: uint8_t | po:=o_Movement_move_av_3);
  Expanded_List_Substitution(Machine(logic),get_o_Movement_move_av_2)==(po: uint8_t | po:=o_Movement_move_av_2);
  Expanded_List_Substitution(Machine(logic),get_o_Movement_move_av_1)==(po: uint8_t | po:=o_Movement_move_av_1);
  Expanded_List_Substitution(Machine(logic),get_o_Movement_move_lv_3)==(po: uint8_t | po:=o_Movement_move_lv_3);
  Expanded_List_Substitution(Machine(logic),get_o_Movement_move_lv_2)==(po: uint8_t | po:=o_Movement_move_lv_2);
  Expanded_List_Substitution(Machine(logic),get_o_Movement_move_lv_1)==(po: uint8_t | po:=o_Movement_move_lv_1);
  Expanded_List_Substitution(Machine(logic),get_o_Movement_move)==(po: uint8_t | po:=o_Movement_move);
  ...
  List_Substitution(Machine(logic),user_logic)==(o_Movement_move:: uint8_t || o_Movement_move_lv_1:: uint8_t || o_Movement_move_lv_2:: uint8_t || o_Movement_move_lv_3:: uint8_t || o_Movement_move_av_1:: uint8_t || o_Movement_move_av_2:: uint8_t || o_Movement_move_av_3:: uint8_t || o_Comm_question:: uint8_t);
  List_Substitution(Machine(logic),get_o_Movement_move)==(po:=o_Movement_move);
  List_Substitution(Machine(logic),get_o_Movement_move_lv_1)==(po:=o_Movement_move_lv_1);
  List_Substitution(Machine(logic),get_o_Movement_move_lv_2)==(po:=o_Movement_move_lv_2);
  List_Substitution(Machine(logic),get_o_Movement_move_lv_3)==(po:=o_Movement_move_lv_3);
  List_Substitution(Machine(logic),get_o_Movement_move_av_1)==(po:=o_Movement_move_av_1);
  List_Substitution(Machine(logic),get_o_Movement_move_av_2)==(po:=o_Movement_move_av_2);
  List_Substitution(Machine(logic),get_o_Movement_move_av_3)==(po:=o_Movement_move_av_3);
  List_Substitution(Machine(logic),get_o_Comm_question)==(po:=o_Comm_question)
END
&
...
THEORY ListANYVarX IS
  ...
  List_ANY_Var(Machine(logic),get_o_Movement_move)==(?);
  List_ANY_Var(Machine(logic),get_o_Movement_move_lv_1)==(?);
  List_ANY_Var(Machine(logic),get_o_Movement_move_lv_2)==(?);
  List_ANY_Var(Machine(logic),get_o_Movement_move_lv_3)==(?);
  List_ANY_Var(Machine(logic),get_o_Movement_move_av_1)==(?);
  List_ANY_Var(Machine(logic),get_o_Movement_move_av_2)==(?);
  List_ANY_Var(Machine(logic),get_o_Movement_move_av_3)==(?);
  List_ANY_Var(Machine(logic),get_o_Comm_question)==(?)
END
&
THEORY ListOfIdsX IS
  List_Of_Ids(Machine(logic)) == (? | ? | o_Comm_question,o_Movement_move_av_3,o_Movement_move_av_2,o_Movement_move_av_1,o_Movement_move_lv_3,o_Movement_move_lv_2,o_Movement_move_lv_1,o_Movement_move | ? | user_logic,get_o_Movement_move,get_o_Movement_move_lv_1,get_o_Movement_move_lv_2,get_o_Movement_move_lv_3,get_o_Movement_move_av_1,get_o_Movement_move_av_2,get_o_Movement_move_av_3,get_o_Comm_question | ? | seen(Machine(g_types)),seen(Machine(g_operators)),seen(Machine(io_constants)),seen(Machine(lchip_interface)),seen(Machine(user_ctx)) | ? | logic);
...
THEORY VariablesEnvX IS
  Variables(Machine(logic)) == (Type(o_Comm_question) == Mvl(btype(INTEGER,?,?));Type(o_Movement_move_av_3) == Mvl(btype(INTEGER,?,?));Type(o_Movement_move_av_2) == Mvl(btype(INTEGER,?,?));Type(o_Movement_move_av_1) == Mvl(btype(INTEGER,?,?));Type(o_Movement_move_lv_3) == Mvl(btype(INTEGER,?,?));Type(o_Movement_move_lv_2) == Mvl(btype(INTEGER,?,?));Type(o_Movement_move_lv_1) == Mvl(btype(INTEGER,?,?));Type(o_Movement_move) == Mvl(btype(INTEGER,?,?)))
END
&
THEORY OperationsEnvX IS
  Operations(Machine(logic)) == (Type(get_o_Comm_question) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_av_3) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_av_2) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_av_1) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_lv_3) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_lv_2) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_lv_1) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move) == Cst(btype(INTEGER,?,?),No_type);Type(user_logic) == Cst(No_type,No_type));
  Observers(Machine(logic)) == (Type(get_o_Comm_question) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_av_3) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_av_2) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_av_1) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_lv_3) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_lv_2) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move_lv_1) == Cst(btype(INTEGER,?,?),No_type);Type(get_o_Movement_move) == Cst(btype(INTEGER,?,?),No_type))
END
&
THEORY TCIntRdX IS
