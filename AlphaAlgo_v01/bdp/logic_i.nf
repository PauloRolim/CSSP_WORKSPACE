...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(logic_i),move)==(l_lv: uint32_t & l_lv: 0..7 & l_av: uint32_t & l_av: 0..7 | (IO_ON: INT | o_Movement_move:=IO_ON);(l_lv: uint32_t & l_lv: 0..7 & o_Movement_move_lv_1: uint8_t & o_Movement_move_lv_2: uint8_t & o_Movement_move_lv_3: uint8_t | @(o2$0).(o2$0: uint8_t ==> o_Movement_move_lv_1:=o2$0) || @(o1$0).(o1$0: uint8_t ==> o_Movement_move_lv_2:=o1$0) || @(o0$0).(o0$0: uint8_t ==> o_Movement_move_lv_3:=o0$0));(l_av: uint32_t & l_av: 0..7 & o_Movement_move_av_1: uint8_t & o_Movement_move_av_2: uint8_t & o_Movement_move_av_3: uint8_t | @(o2$0).(o2$0: uint8_t ==> o_Movement_move_av_1:=o2$0) || @(o1$0).(o1$0: uint8_t ==> o_Movement_move_av_2:=o1$0) || @(o0$0).(o0$0: uint8_t ==> o_Movement_move_av_3:=o0$0)));
  ...
  List_Substitution(Implementation(logic_i),move)==(o_Movement_move:=IO_ON;o_Movement_move_lv_1,o_Movement_move_lv_2,o_Movement_move_lv_3 <-- nat_3_bits_to_bin_3_bits(l_lv);o_Movement_move_av_1,o_Movement_move_av_2,o_Movement_move_av_3 <-- nat_3_bits_to_bin_3_bits(l_av));
  ...
  List_Substitution(Implementation(logic_i),communication)==(ms_tick_cycle <-- get_ms_tick;s_tick_cycle:=ms_tick_cycle/MBC;tick:=s_tick_cycle mod 2;IF tick = 0 THEN o_Comm_question:=IO_ON ELSE o_Comm_question:=IO_OFF END);
