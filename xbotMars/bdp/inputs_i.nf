...
THEORY ListVariablesX IS
  ...
  Abstract_List_Variables(Implementation(inputs_i))==(Obstacle);
...
THEORY ListVisibleVariablesX IS
  ...
  List_VisibleVariables(Implementation(inputs_i))==(Obstacle);
  Internal_List_VisibleVariables(Implementation(inputs_i))==(Obstacle)
END
&
THEORY ListInvariantX IS
  Gluing_Seen_List_Invariant(Implementation(inputs_i))==(btrue);
  Expanded_List_Invariant(Implementation(inputs_i))==(btrue);
  Abstract_List_Invariant(Implementation(inputs_i))==(Obstacle: uint8_t);
  Context_List_Invariant(Implementation(inputs_i))==(ms_tick: uint32_t);
  List_Invariant(Implementation(inputs_i))==(Obstacle: uint8_t)
END
&
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Implementation(inputs_i))==(IO_OFF: INT | Obstacle:=IO_OFF);
  Context_List_Initialisation(Implementation(inputs_i))==(skip);
  List_Initialisation(Implementation(inputs_i))==(Obstacle:=IO_OFF)
END
&
...
THEORY ListOperationsX IS
  Internal_List_Operations(Implementation(inputs_i))==(read_inputs,get_Obstacle);
  List_Operations(Implementation(inputs_i))==(read_inputs,get_Obstacle)
END
&
THEORY ListInputX IS
  List_Input(Implementation(inputs_i),read_inputs)==(?);
  List_Input(Implementation(inputs_i),get_Obstacle)==(?)
END
&
THEORY ListOutputX IS
  List_Output(Implementation(inputs_i),read_inputs)==(?);
  List_Output(Implementation(inputs_i),get_Obstacle)==(po)
END
&
THEORY ListHeaderX IS
  List_Header(Implementation(inputs_i),read_inputs)==(read_inputs);
  List_Header(Implementation(inputs_i),get_Obstacle)==(po <-- get_Obstacle)
END
&
THEORY ListPreconditionX IS
  ...
  Own_Precondition(Implementation(inputs_i),get_Obstacle)==(btrue);
  List_Precondition(Implementation(inputs_i),get_Obstacle)==(po: uint8_t)
END
&
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Implementation(inputs_i),get_Obstacle)==(po: uint8_t & Obstacle: INT | po:=Obstacle);
  Expanded_List_Substitution(Implementation(inputs_i),read_inputs)==(btrue & 0: uint8_t & 0<MAX_NB_INPUTS & Obstacle: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> Obstacle:=state$1));
  List_Substitution(Implementation(inputs_i),read_inputs)==(Obstacle <-- read_global_input(0));
  List_Substitution(Implementation(inputs_i),get_Obstacle)==(po:=Obstacle)
END
&
...
THEORY InheritedEnvX IS
  VisibleVariables(Implementation(inputs_i))==(Type(Obstacle) == Mvv(btype(INTEGER,?,?)));
  Operations(Implementation(inputs_i))==(Type(get_Obstacle) == Cst(btype(INTEGER,?,?),No_type);Type(read_inputs) == Cst(No_type,No_type))
END
&
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(inputs_i)) == (? | ? | ? | ? | read_inputs,get_Obstacle | ? | seen(Machine(g_types)),seen(Machine(io_constants)),seen(Machine(lchip_configuration)),seen(Machine(lchip_interface)) | ? | inputs_i);
  List_Of_HiddenCst_Ids(Implementation(inputs_i)) == (? | ?);
  List_Of_VisibleCst_Ids(Implementation(inputs_i)) == (?);
  List_Of_VisibleVar_Ids(Implementation(inputs_i)) == (Obstacle | ?);
...
THEORY TypingPredicateX IS
  TypingPredicate(Implementation(inputs_i))==(Obstacle: INTEGER)
END
&
