...
THEORY ListVariablesX IS
  ...
  List_Variables(Implementation(user_component_i))==(Obstacle,COUNTER,AngularVel,LinearVel);
  External_List_Variables(Implementation(user_component_i))==(Obstacle,COUNTER,AngularVel,LinearVel)
END
&
...
THEORY ListInvariantX IS
  ...
  Expanded_List_Invariant(Implementation(user_component_i))==(Obstacle: uint8_t & LinearVel: uint8_t & AngularVel: uint8_t & COUNTER: uint8_t);
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Implementation(user_component_i))==(@(Obstacle$0).(Obstacle$0: uint8_t ==> Obstacle:=Obstacle$0);(@(LinearVel$0).(LinearVel$0: uint8_t ==> LinearVel:=LinearVel$0) || @(AngularVel$0).(AngularVel$0: uint8_t ==> AngularVel:=AngularVel$0) || COUNTER:=0);(0: INT | divergence_test_var:=0));
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(user_component_i),user_app)==(btrue | (0: INT | divergence_test_var:=0);(btrue | @(Obstacle$0).(Obstacle$0: uint8_t ==> Obstacle:=Obstacle$0));(btrue | @(LinearVel$1,AngularVel$1,COUNTER$1).(LinearVel$1: uint8_t & AngularVel$1: uint8_t & COUNTER$1: uint8_t & (LinearVel$1 = IO_ON & AngularVel$1 = IO_OFF or (LinearVel$1 = IO_OFF & AngularVel$1 = IO_ON)) & COUNTER$1 = 0 <=> (LinearVel$1 = IO_OFF & AngularVel$1 = IO_ON) & COUNTER$1 = 1 <=> (LinearVel$1 = IO_ON & AngularVel$1 = IO_OFF) ==> LinearVel,AngularVel,COUNTER:=LinearVel$1,AngularVel$1,COUNTER$1));(btrue | skip));
...
THEORY ListConstantsX IS
  ...
  Inherited_List_Constants(Implementation(user_component_i))==(delta_t,delta_t1);
...
THEORY ListPropertiesX IS
  ...
  Inherited_List_Properties(Implementation(user_component_i))==(delta_t: uint32_t & not(delta_t = 0) & delta_t1: uint32_t & not(delta_t1 = 0));
...
THEORY ListIncludedOperationsX IS
  ...
  List_Included_Operations(Implementation(user_component_i),Machine(logic))==(user_logic,get_LinearVel,get_AngularVel);
  List_Included_Operations(Implementation(user_component_i),Machine(inputs))==(read_inputs,get_Obstacle)
END
&
...
THEORY ListVisibleStaticX IS
  List_Constants(Implementation(user_component_i),Machine(user_ctx))==(delta_t,delta_t1);
  List_Constants_Env(Implementation(user_component_i),Machine(user_ctx))==(Type(delta_t) == Cst(btype(INTEGER,?,?));Type(delta_t1) == Cst(btype(INTEGER,?,?)));
...
THEORY ListOfIdsX IS
  ...
  List_Of_Ids(Machine(logic)) == (? | ? | COUNTER,AngularVel,LinearVel | ? | user_logic,get_LinearVel,get_AngularVel | ? | seen(Machine(g_types)),seen(Machine(g_operators)),seen(Machine(io_constants)),seen(Machine(lchip_interface)),seen(Machine(user_ctx)) | ? | logic);
...
THEORY ConstantsEnvX IS
  Constants(Implementation(user_component_i)) == (Type(delta_t1) == Cst(btype(INTEGER,?,?));Type(delta_t) == Cst(btype(INTEGER,?,?)))
END
&
...
THEORY ImportedVariablesListX IS
  ...
  ImportedVariablesList(Implementation(user_component_i),Machine(inputs))==(Obstacle);
  ImportedVisVariablesList(Implementation(user_component_i),Machine(inputs))==(?);
  ImportedVariablesList(Implementation(user_component_i),Machine(logic))==(COUNTER,AngularVel,LinearVel);
