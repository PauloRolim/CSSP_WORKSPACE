...
THEORY ListVariablesX IS
  ...
  Local_List_Variables(Machine(logic))==(COUNTER,AngularVel,LinearVel);
  List_Variables(Machine(logic))==(COUNTER,AngularVel,LinearVel);
  External_List_Variables(Machine(logic))==(COUNTER,AngularVel,LinearVel)
END
&
...
THEORY ListInvariantX IS
  ...
  List_Invariant(Machine(logic))==(LinearVel: uint8_t & AngularVel: uint8_t & COUNTER: uint8_t)
END
&
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Machine(logic))==(@(LinearVel$0).(LinearVel$0: uint8_t ==> LinearVel:=LinearVel$0) || @(AngularVel$0).(AngularVel$0: uint8_t ==> AngularVel:=AngularVel$0) || COUNTER:=0);
  Context_List_Initialisation(Machine(logic))==(skip);
  List_Initialisation(Machine(logic))==(LinearVel:: uint8_t || AngularVel:: uint8_t || COUNTER:=0)
END
&
...
THEORY ListOperationsX IS
  Internal_List_Operations(Machine(logic))==(user_logic,get_LinearVel,get_AngularVel);
  List_Operations(Machine(logic))==(user_logic,get_LinearVel,get_AngularVel)
END
&
THEORY ListInputX IS
  List_Input(Machine(logic),user_logic)==(?);
  List_Input(Machine(logic),get_LinearVel)==(?);
  List_Input(Machine(logic),get_AngularVel)==(?)
END
&
THEORY ListOutputX IS
  List_Output(Machine(logic),user_logic)==(?);
  List_Output(Machine(logic),get_LinearVel)==(po);
  List_Output(Machine(logic),get_AngularVel)==(po)
END
&
THEORY ListHeaderX IS
  List_Header(Machine(logic),user_logic)==(user_logic);
  List_Header(Machine(logic),get_LinearVel)==(po <-- get_LinearVel);
  List_Header(Machine(logic),get_AngularVel)==(po <-- get_AngularVel)
END
&
...
THEORY ListPreconditionX IS
  ...
  List_Precondition(Machine(logic),get_LinearVel)==(po: uint8_t);
  List_Precondition(Machine(logic),get_AngularVel)==(po: uint8_t)
END
&
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Machine(logic),get_AngularVel)==(po: uint8_t | po:=AngularVel);
  Expanded_List_Substitution(Machine(logic),get_LinearVel)==(po: uint8_t | po:=LinearVel);
  Expanded_List_Substitution(Machine(logic),user_logic)==(btrue | @(LinearVel$1,AngularVel$1,COUNTER$1).(LinearVel$1: uint8_t & AngularVel$1: uint8_t & COUNTER$1: uint8_t & (LinearVel$1 = IO_ON & AngularVel$1 = IO_OFF or (LinearVel$1 = IO_OFF & AngularVel$1 = IO_ON)) & COUNTER$1 = 0 <=> (LinearVel$1 = IO_OFF & AngularVel$1 = IO_ON) & COUNTER$1 = 1 <=> (LinearVel$1 = IO_ON & AngularVel$1 = IO_OFF) ==> LinearVel,AngularVel,COUNTER:=LinearVel$1,AngularVel$1,COUNTER$1));
  List_Substitution(Machine(logic),user_logic)==(LinearVel,AngularVel,COUNTER: (LinearVel: uint8_t & AngularVel: uint8_t & COUNTER: uint8_t & (LinearVel = IO_ON & AngularVel = IO_OFF or (LinearVel = IO_OFF & AngularVel = IO_ON)) & COUNTER = 0 <=> (LinearVel = IO_OFF & AngularVel = IO_ON) & COUNTER = 1 <=> (LinearVel = IO_ON & AngularVel = IO_OFF)));
  List_Substitution(Machine(logic),get_LinearVel)==(po:=LinearVel);
  List_Substitution(Machine(logic),get_AngularVel)==(po:=AngularVel)
END
&
...
THEORY ListANYVarX IS
  ...
  List_ANY_Var(Machine(logic),get_LinearVel)==(?);
  List_ANY_Var(Machine(logic),get_AngularVel)==(?)
END
&
...
THEORY VariablesEnvX IS
  Variables(Machine(logic)) == (Type(COUNTER) == Mvl(btype(INTEGER,?,?));Type(AngularVel) == Mvl(btype(INTEGER,?,?));Type(LinearVel) == Mvl(btype(INTEGER,?,?)))
END
&
THEORY OperationsEnvX IS
  Operations(Machine(logic)) == (Type(get_AngularVel) == Cst(btype(INTEGER,?,?),No_type);Type(get_LinearVel) == Cst(btype(INTEGER,?,?),No_type);Type(user_logic) == Cst(No_type,No_type));
  Observers(Machine(logic)) == (Type(get_AngularVel) == Cst(btype(INTEGER,?,?),No_type);Type(get_LinearVel) == Cst(btype(INTEGER,?,?),No_type))
END
&
THEORY TCIntRdX IS
