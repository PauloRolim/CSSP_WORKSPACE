...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(inputs_i),read_inputs)==(btrue | (0: uint8_t & 0<MAX_NB_INPUTS & board_0_I1: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I1:=state$1));(1: uint8_t & 1<MAX_NB_INPUTS & board_0_I2: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I2:=state$1));(2: uint8_t & 2<MAX_NB_INPUTS & board_0_I3: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I3:=state$1));(3: uint8_t & 3<MAX_NB_INPUTS & board_0_I4: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I4:=state$1));(4: uint8_t & 4<MAX_NB_INPUTS & board_0_I5: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I5:=state$1));(5: uint8_t & 5<MAX_NB_INPUTS & board_0_I6: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I6:=state$1));(6: uint8_t & 6<MAX_NB_INPUTS & board_0_I7: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I7:=state$1));(7: uint8_t & 7<MAX_NB_INPUTS & board_0_I8: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I8:=state$1));(8: uint8_t & 8<MAX_NB_INPUTS & board_0_I9: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I9:=state$1));(9: uint8_t & 9<MAX_NB_INPUTS & board_0_I10: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I10:=state$1));(10: uint8_t & 10<MAX_NB_INPUTS & board_0_I11: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I11:=state$1));(11: uint8_t & 11<MAX_NB_INPUTS & board_0_I12: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I12:=state$1));(12: uint8_t & 12<MAX_NB_INPUTS & board_0_I13: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I13:=state$1));(13: uint8_t & 13<MAX_NB_INPUTS & board_0_I14: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I14:=state$1));(14: uint8_t & 14<MAX_NB_INPUTS & board_0_I15: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I15:=state$1));(15: uint8_t & 15<MAX_NB_INPUTS & board_0_I16: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I16:=state$1));(16: uint8_t & 16<MAX_NB_INPUTS & board_0_I17: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I17:=state$1));(17: uint8_t & 17<MAX_NB_INPUTS & board_0_I18: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I18:=state$1));(18: uint8_t & 18<MAX_NB_INPUTS & board_0_I19: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I19:=state$1));(19: uint8_t & 19<MAX_NB_INPUTS & board_0_I20: uint8_t | @(state$1).(state$1: uint8_t & (state$1 = IO_ON or state$1 = IO_OFF) ==> board_0_I20:=state$1)));
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(inputs_i)) == (? | ? | ? | ? | read_inputs,get_board_0_I1,get_board_0_I2,get_board_0_I3,get_board_0_I4,get_board_0_I5,get_board_0_I6,get_board_0_I7,get_board_0_I8,get_board_0_I9,get_board_0_I10,get_board_0_I11,get_board_0_I12,get_board_0_I13,get_board_0_I14,get_board_0_I15,get_board_0_I16,get_board_0_I17,get_board_0_I18,get_board_0_I19,get_board_0_I20 | ? | seen(Machine(g_types)),seen(Machine(io_constants)),seen(Machine(lchip_configuration)),seen(Machine(lchip_interface)) | ? | inputs_i);
