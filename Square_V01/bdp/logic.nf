...
THEORY ListVariablesX IS
  ...
  Local_List_Variables(Machine(logic))==(board_0_O8,board_0_O7,board_0_O6,board_0_O5,board_0_O4,board_0_O3,board_0_O2,board_0_O1);
  List_Variables(Machine(logic))==(board_0_O8,board_0_O7,board_0_O6,board_0_O5,board_0_O4,board_0_O3,board_0_O2,board_0_O1);
  External_List_Variables(Machine(logic))==(board_0_O8,board_0_O7,board_0_O6,board_0_O5,board_0_O4,board_0_O3,board_0_O2,board_0_O1)
END
&
...
THEORY ListInvariantX IS
  ...
  List_Invariant(Machine(logic))==(board_0_O1: uint8_t & board_0_O2: uint8_t & board_0_O3: uint8_t & board_0_O4: uint8_t & board_0_O5: uint8_t & board_0_O6: uint8_t & board_0_O7: uint8_t & board_0_O8: uint8_t)
END
&
...
THEORY ListOperationsX IS
  Internal_List_Operations(Machine(logic))==(user_logic,get_board_0_O1,get_board_0_O2,get_board_0_O3,get_board_0_O4,get_board_0_O5,get_board_0_O6,get_board_0_O7,get_board_0_O8);
  List_Operations(Machine(logic))==(user_logic,get_board_0_O1,get_board_0_O2,get_board_0_O3,get_board_0_O4,get_board_0_O5,get_board_0_O6,get_board_0_O7,get_board_0_O8)
END
&
THEORY ListInputX IS
  ...
  List_Input(Machine(logic),get_board_0_O3)==(?);
  List_Input(Machine(logic),get_board_0_O4)==(?);
  List_Input(Machine(logic),get_board_0_O5)==(?);
  List_Input(Machine(logic),get_board_0_O6)==(?);
  List_Input(Machine(logic),get_board_0_O7)==(?);
  List_Input(Machine(logic),get_board_0_O8)==(?)
END
&
THEORY ListOutputX IS
  ...
  List_Output(Machine(logic),get_board_0_O3)==(po);
  List_Output(Machine(logic),get_board_0_O4)==(po);
  List_Output(Machine(logic),get_board_0_O5)==(po);
  List_Output(Machine(logic),get_board_0_O6)==(po);
  List_Output(Machine(logic),get_board_0_O7)==(po);
  List_Output(Machine(logic),get_board_0_O8)==(po)
END
&
THEORY ListHeaderX IS
  ...
  List_Header(Machine(logic),get_board_0_O3)==(po <-- get_board_0_O3);
  List_Header(Machine(logic),get_board_0_O4)==(po <-- get_board_0_O4);
  List_Header(Machine(logic),get_board_0_O5)==(po <-- get_board_0_O5);
  List_Header(Machine(logic),get_board_0_O6)==(po <-- get_board_0_O6);
  List_Header(Machine(logic),get_board_0_O7)==(po <-- get_board_0_O7);
  List_Header(Machine(logic),get_board_0_O8)==(po <-- get_board_0_O8)
END
&
...
THEORY ListPreconditionX IS
  ...
  List_Precondition(Machine(logic),get_board_0_O3)==(po: uint8_t);
  List_Precondition(Machine(logic),get_board_0_O4)==(po: uint8_t);
  List_Precondition(Machine(logic),get_board_0_O5)==(po: uint8_t);
  List_Precondition(Machine(logic),get_board_0_O6)==(po: uint8_t);
  List_Precondition(Machine(logic),get_board_0_O7)==(po: uint8_t);
  List_Precondition(Machine(logic),get_board_0_O8)==(po: uint8_t)
END
&
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Machine(logic),get_board_0_O8)==(po: uint8_t | po:=board_0_O8);
  Expanded_List_Substitution(Machine(logic),get_board_0_O7)==(po: uint8_t | po:=board_0_O7);
  Expanded_List_Substitution(Machine(logic),get_board_0_O6)==(po: uint8_t | po:=board_0_O6);
  Expanded_List_Substitution(Machine(logic),get_board_0_O5)==(po: uint8_t | po:=board_0_O5);
  Expanded_List_Substitution(Machine(logic),get_board_0_O4)==(po: uint8_t | po:=board_0_O4);
  Expanded_List_Substitution(Machine(logic),get_board_0_O3)==(po: uint8_t | po:=board_0_O3);
  ...
  Expanded_List_Substitution(Machine(logic),user_logic)==(btrue | @(board_0_O1$0).(board_0_O1$0: uint8_t ==> board_0_O1:=board_0_O1$0) || @(board_0_O2$0).(board_0_O2$0: uint8_t ==> board_0_O2:=board_0_O2$0) || @(board_0_O3$0).(board_0_O3$0: uint8_t ==> board_0_O3:=board_0_O3$0) || @(board_0_O4$0).(board_0_O4$0: uint8_t ==> board_0_O4:=board_0_O4$0) || @(board_0_O5$0).(board_0_O5$0: uint8_t ==> board_0_O5:=board_0_O5$0) || @(board_0_O6$0).(board_0_O6$0: uint8_t ==> board_0_O6:=board_0_O6$0) || @(board_0_O7$0).(board_0_O7$0: uint8_t ==> board_0_O7:=board_0_O7$0) || @(board_0_O8$0).(board_0_O8$0: uint8_t ==> board_0_O8:=board_0_O8$0));
  List_Substitution(Machine(logic),user_logic)==(board_0_O1:: uint8_t || board_0_O2:: uint8_t || board_0_O3:: uint8_t || board_0_O4:: uint8_t || board_0_O5:: uint8_t || board_0_O6:: uint8_t || board_0_O7:: uint8_t || board_0_O8:: uint8_t);
  List_Substitution(Machine(logic),get_board_0_O1)==(po:=board_0_O1);
  List_Substitution(Machine(logic),get_board_0_O2)==(po:=board_0_O2);
  List_Substitution(Machine(logic),get_board_0_O3)==(po:=board_0_O3);
  List_Substitution(Machine(logic),get_board_0_O4)==(po:=board_0_O4);
  List_Substitution(Machine(logic),get_board_0_O5)==(po:=board_0_O5);
  List_Substitution(Machine(logic),get_board_0_O6)==(po:=board_0_O6);
  List_Substitution(Machine(logic),get_board_0_O7)==(po:=board_0_O7);
  List_Substitution(Machine(logic),get_board_0_O8)==(po:=board_0_O8)
END
&
...
&
THEORY ListSetsX IS
  Set_Definition(Machine(logic),STATE)==({NONE,SMovingForward,SObserving,DObserving,STurning,DTurning,Waiting,EObserving,SCollision});
...
THEORY ListANYVarX IS
  ...
  List_ANY_Var(Machine(logic),get_board_0_O3)==(?);
  List_ANY_Var(Machine(logic),get_board_0_O4)==(?);
  List_ANY_Var(Machine(logic),get_board_0_O5)==(?);
  List_ANY_Var(Machine(logic),get_board_0_O6)==(?);
  List_ANY_Var(Machine(logic),get_board_0_O7)==(?);
  List_ANY_Var(Machine(logic),get_board_0_O8)==(?)
END
&
...
THEORY VariablesEnvX IS
  Variables(Machine(logic)) == (Type(board_0_O8) == Mvl(btype(INTEGER,?,?));Type(board_0_O7) == Mvl(btype(INTEGER,?,?));Type(board_0_O6) == Mvl(btype(INTEGER,?,?));Type(board_0_O5) == Mvl(btype(INTEGER,?,?));Type(board_0_O4) == Mvl(btype(INTEGER,?,?));Type(board_0_O3) == Mvl(btype(INTEGER,?,?));Type(board_0_O2) == Mvl(btype(INTEGER,?,?));Type(board_0_O1) == Mvl(btype(INTEGER,?,?)))
END
&
THEORY OperationsEnvX IS
  Operations(Machine(logic)) == (Type(get_board_0_O8) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O7) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O6) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O5) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O4) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O3) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O2) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O1) == Cst(btype(INTEGER,?,?),No_type);Type(user_logic) == Cst(No_type,No_type));
  Observers(Machine(logic)) == (Type(get_board_0_O8) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O7) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O6) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O5) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O4) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O3) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O2) == Cst(btype(INTEGER,?,?),No_type);Type(get_board_0_O1) == Cst(btype(INTEGER,?,?),No_type))
END
&
THEORY TCIntRdX IS
