...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(logic_i),user_logic)==(btrue | (btrue | @(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0) || @(O3$0).(O3$0: uint8_t ==> O3:=O3$0) || @(O4$0).(O4$0: uint8_t ==> O4:=O4$0) || @(O5$0).(O5$0: uint8_t ==> O5:=O5$0) || @(O6$0).(O6$0: uint8_t ==> O6:=O6$0) || @(O7$0).(O7$0: uint8_t ==> O7:=O7$0) || @(O8$0).(O8$0: uint8_t ==> O8:=O8$0));(0: uint32_t & 0: 0..7 & av: uint32_t & av: 0..7 | @(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0) || @(O3$0).(O3$0: uint8_t ==> O3:=O3$0) || @(O4$0).(O4$0: uint8_t ==> O4:=O4$0) || @(O5$0).(O5$0: uint8_t ==> O5:=O5$0) || @(O6$0).(O6$0: uint8_t ==> O6:=O6$0) || @(O7$0).(O7$0: uint8_t ==> O7:=O7$0));@(local_input,local_input2).(@(local_input$2).(local_input$2: uint32_t ==> local_input:=local_input$2);@(local_input2$2).(local_input2$2: uint32_t ==> local_input2:=local_input2$2);(local_input: uint8_t | local_input:=I2);(local_input2: uint8_t | local_input2:=I3);(local_input = IO_ON ==> (btrue | @(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0) || @(O3$0).(O3$0: uint8_t ==> O3:=O3$0) || @(O4$0).(O4$0: uint8_t ==> O4:=O4$0) || @(O5$0).(O5$0: uint8_t ==> O5:=O5$0) || @(O6$0).(O6$0: uint8_t ==> O6:=O6$0) || @(O7$0).(O7$0: uint8_t ==> O7:=O7$0) || @(O8$0).(O8$0: uint8_t ==> O8:=O8$0)) [] not(local_input = IO_ON) ==> skip);(local_input2 = IO_ON ==> (lv: uint32_t & lv: 0..7 & 0: uint32_t & 0: 0..7 | @(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0) || @(O3$0).(O3$0: uint8_t ==> O3:=O3$0) || @(O4$0).(O4$0: uint8_t ==> O4:=O4$0) || @(O5$0).(O5$0: uint8_t ==> O5:=O5$0) || @(O6$0).(O6$0: uint8_t ==> O6:=O6$0) || @(O7$0).(O7$0: uint8_t ==> O7:=O7$0)) [] not(local_input2 = IO_ON) ==> skip)));
  ...
  List_Substitution(Implementation(logic_i),user_logic)==(reset_outputs;move(0,av);VAR local_input,local_input2 IN local_input: (local_input: uint32_t);local_input2: (local_input2: uint32_t);local_input <-- get_I2;local_input2 <-- get_I3;IF local_input = IO_ON THEN reset_outputs END;IF local_input2 = IO_ON THEN move(lv,0) END END);
