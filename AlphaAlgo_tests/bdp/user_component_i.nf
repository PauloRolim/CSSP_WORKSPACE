...
THEORY ListConstantsX IS
  ...
  Inherited_List_Constants(Implementation(user_component_i))==(cycle_unit,SimSMovement_cycle_def,av,lv,pi,zero,alpha);
...
THEORY ListPropertiesX IS
  ...
  Inherited_List_Properties(Implementation(user_component_i))==(cycle_unit: uint32_t & SimSMovement_cycle_def: uint32_t & av: uint32_t & lv: uint32_t & pi: uint32_t & zero: uint32_t & av: -3..3 & lv: 0..3 & alpha: uint8_t & STATE: FIN(INTEGER) & not(STATE = {}));
...
THEORY ListVisibleStaticX IS
  List_Constants(Implementation(user_component_i),Machine(user_ctx))==(cycle_unit,SimSMovement_cycle_def,av,lv,pi,zero,alpha);
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(user_component_i)) == (? | cycle_unit,SimSMovement_cycle_def,av,lv,pi,zero,alpha,STATE,INIT,EXEC_1,EXEC_2 | ? | board_0_O8,board_0_O7,board_0_O6,board_0_O5,board_0_O4,board_0_O3,board_0_O2,board_0_O1,board_0_I20,board_0_I19,board_0_I18,board_0_I17,board_0_I16,board_0_I15,board_0_I14,board_0_I13,board_0_I12,board_0_I11,board_0_I10,board_0_I9,board_0_I8,board_0_I7,board_0_I6,board_0_I5,board_0_I4,board_0_I3,board_0_I2,board_0_I1 | user_app,user_consistency_error_detection_test | ? | seen(Machine(g_types)),imported(Machine(user_ctx)),imported(Machine(inputs)),imported(Machine(logic)),imported(Machine(outputs)) | ? | user_component_i);
  List_Of_HiddenCst_Ids(Implementation(user_component_i)) == (? | ?);
  List_Of_VisibleCst_Ids(Implementation(user_component_i)) == (cycle_unit,SimSMovement_cycle_def,av,lv,pi,zero,alpha);
  List_Of_VisibleVar_Ids(Implementation(user_component_i)) == (divergence_test_var | ?);
  List_Of_Ids_SeenBNU(Implementation(user_component_i)) == (seen(Machine(g_types)): (uint32_t,uint16_t,uint8_t,STRUE,SFALSE,MAX_UINT32,MAX_UINT16,MAX_UINT8 | ? | ? | ? | ? | ? | SBOOL,Convert_Bool | ? | ?) | seen(Machine(g_operators)): (bitwise_sll_uint32,bitwise_srl_uint32,bitwise_not_uint32,bitwise_and_uint32,bitwise_xor_uint32,bitwise_or_uint32,bitwise_sll_uint16,bitwise_srl_uint16,bitwise_not_uint16,bitwise_and_uint16,bitwise_xor_uint16,bitwise_or_uint16,bitwise_sll_uint8,bitwise_srl_uint8,bitwise_not_uint8,bitwise_and_uint8,bitwise_xor_uint8,bitwise_or_uint8,add_uint32,sub_uint32,mul_uint32,add_uint16,sub_uint16,mul_uint16,add_uint8,sub_uint8,mul_uint8 | ? | ? | ? | ? | ? | ? | ? | ?) | seen(Machine(io_constants)): (IO_ON,IO_OFF | ? | ? | ? | ? | ? | IO_STATE,TIME | ? | ?) | seen(Machine(lchip_interface)): (? | ? | ms_tick | ? | ? | ? | ? | ? | ?) | seen(Machine(user_ctx)): (cycle_unit,SimSMovement_cycle_def,av,lv,pi,zero,alpha,STATE,INIT,EXEC_1,EXEC_2 | ? | ? | ? | ? | ? | ? | ? | ?));
