...
THEORY ListVisibleVariablesX IS
  ...
  List_VisibleVariables(Implementation(logic_i))==(tick,s_tick_cycle,ms_tick_cycle,first_time,cycle_timer,MBC,smstate,board_0_O8,board_0_O7,board_0_O6,board_0_O5,board_0_O4,board_0_O3,board_0_O2,board_0_O1);
  Internal_List_VisibleVariables(Implementation(logic_i))==(tick,s_tick_cycle,ms_tick_cycle,first_time,cycle_timer,MBC,smstate,board_0_O8,board_0_O7,board_0_O6,board_0_O5,board_0_O4,board_0_O3,board_0_O2,board_0_O1)
END
&
...
THEORY ListInitialisationX IS
  ...
  List_Initialisation(Implementation(logic_i))==(board_0_O1:=IO_OFF;board_0_O2:=IO_OFF;board_0_O3:=IO_OFF;board_0_O4:=IO_OFF;board_0_O5:=IO_OFF;board_0_O6:=IO_OFF;board_0_O7:=IO_OFF;board_0_O8:=IO_OFF;smstate:=INIT;MBC:=0;cycle_timer:=0;first_time:=TRUE;ms_tick_cycle:=0;s_tick_cycle:=0;tick:=0)
END
&
...
THEORY ListOperationsX IS
  Internal_List_Operations(Implementation(logic_i))==(reset_outputs,avoid,since,nat_3_bits_to_bin_3_bits,moveForward,turn,state_machine,communication,infoNeighbours,user_logic,get_board_0_O1,get_board_0_O2,get_board_0_O3,get_board_0_O4,get_board_0_O5,get_board_0_O6,get_board_0_O7,get_board_0_O8);
  List_Operations(Implementation(logic_i))==(reset_outputs,avoid,since,nat_3_bits_to_bin_3_bits,moveForward,turn,state_machine,communication,infoNeighbours,user_logic,get_board_0_O1,get_board_0_O2,get_board_0_O3,get_board_0_O4,get_board_0_O5,get_board_0_O6,get_board_0_O7,get_board_0_O8)
END
&
...
THEORY ListPreconditionX IS
  ...
  List_Precondition(Implementation(logic_i),nat_3_bits_to_bin_3_bits)==(nn: uint32_t & nn: 0..3 & o2: uint8_t & o1: uint8_t & o0: uint8_t);
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(logic_i),state_machine)==(MBC: uint32_t & smstate: STATE & cycle_timer: uint32_t & lv: uint32_t & lv: 0..3 & av: uint32_t & av: 0..3 & board_0_O1: uint8_t & board_0_O2: uint8_t & board_0_O3: uint8_t & board_0_O4: uint8_t & board_0_O5: uint8_t & board_0_O6: uint8_t & board_0_O7: uint8_t & board_0_O8: uint8_t | smstate = INIT ==> ((lv: uint32_t & lv: 0..3 | @(board_0_O1$0).(board_0_O1$0: uint8_t ==> board_0_O1:=board_0_O1$0) || @(board_0_O2$0).(board_0_O2$0: uint8_t ==> board_0_O2:=board_0_O2$0) || @(board_0_O3$0).(board_0_O3$0: uint8_t ==> board_0_O3:=board_0_O3$0));smstate:=EXEC_1) [] not(smstate = INIT) ==> (smstate = EXEC_1 ==> @local_obstacle.(@(local_obstacle$2).(local_obstacle$2: uint8_t ==> local_obstacle:=local_obstacle$2);(local_obstacle: uint8_t | local_obstacle:=board_0_I1);(local_obstacle = IO_ON ==> ((MBC: uint32_t | MBC:=ms_tick);(btrue | @(board_0_O7$0).(board_0_O7$0: uint8_t ==> board_0_O7:=board_0_O7$0));(av: uint32_t & av: 0..3 | @(board_0_O4$0).(board_0_O4$0: uint8_t ==> board_0_O4:=board_0_O4$0) || @(board_0_O5$0).(board_0_O5$0: uint8_t ==> board_0_O5:=board_0_O5$0) || @(board_0_O6$0).(board_0_O6$0: uint8_t ==> board_0_O6:=board_0_O6$0));smstate:=EXEC_2) [] not(local_obstacle = IO_ON) ==> (local_obstacle = IO_OFF ==> smstate:=EXEC_1 [] not(local_obstacle = IO_OFF) ==> skip))) [] not(smstate = EXEC_1) ==> (smstate = EXEC_2 ==> @since_value.(@(since_value$2).(since_value$2: uint32_t ==> since_value:=since_value$2);(MBC: uint32_t & since_value: uint32_t | @(elapsed$0).(elapsed$0: uint32_t ==> since_value:=elapsed$0));@pi_div_av.(@(pi_div_av$2).(pi_div_av$2: uint32_t ==> pi_div_av:=pi_div_av$2);(pi/av: INT & pi: INT & av: INT & not(av = 0) | pi_div_av:=pi/av);(since_value<pi_div_av ==> smstate:=EXEC_2 [] not(since_value<pi_div_av) ==> (pi_div_av<=since_value ==> ((lv: uint32_t & lv: 0..3 | @(board_0_O1$0).(board_0_O1$0: uint8_t ==> board_0_O1:=board_0_O1$0) || @(board_0_O2$0).(board_0_O2$0: uint8_t ==> board_0_O2:=board_0_O2$0) || @(board_0_O3$0).(board_0_O3$0: uint8_t ==> board_0_O3:=board_0_O3$0));smstate:=EXEC_1) [] not(pi_div_av<=since_value) ==> skip)))) [] not(smstate = EXEC_2) ==> skip)));
  Expanded_List_Substitution(Implementation(logic_i),turn)==(l_angular: uint32_t & l_angular: 0..3 & l_angular: uint32_t & l_angular: 0..3 & board_0_O6: uint8_t & board_0_O5: uint8_t & board_0_O4: uint8_t | @(o2$0).(o2$0: uint8_t ==> board_0_O6:=o2$0) || @(o1$0).(o1$0: uint8_t ==> board_0_O5:=o1$0) || @(o0$0).(o0$0: uint8_t ==> board_0_O4:=o0$0));
  Expanded_List_Substitution(Implementation(logic_i),moveForward)==(l_linear: uint32_t & l_linear: 0..3 & l_linear: uint32_t & l_linear: 0..3 & board_0_O3: uint8_t & board_0_O2: uint8_t & board_0_O1: uint8_t | @(o2$0).(o2$0: uint8_t ==> board_0_O3:=o2$0) || @(o1$0).(o1$0: uint8_t ==> board_0_O2:=o1$0) || @(o0$0).(o0$0: uint8_t ==> board_0_O1:=o0$0));
  Expanded_List_Substitution(Implementation(logic_i),nat_3_bits_to_bin_3_bits)==(nn: uint32_t & nn: 0..3 & o2: uint8_t & o1: uint8_t & o0: uint8_t | @(o2$1).(o2$1: uint8_t ==> o2:=o2$1);@(o1$1).(o1$1: uint8_t ==> o1:=o1$1);@(o0$1).(o0$1: uint8_t ==> o0:=o0$1);@o_aux.(@(o_aux$2).(o_aux$2: uint32_t ==> o_aux:=o_aux$2);(nn mod 2: INT & nn mod 2: NAT & nn: NAT & 2: NAT1 | o_aux:=nn mod 2);(o_aux = 0 ==> (IO_OFF: INT | o0:=IO_OFF) [] not(o_aux = 0) ==> (IO_ON: INT | o0:=IO_ON));(nn/2: INT & nn: INT & 2: INT & not(2 = 0) | o_aux:=nn/2);(o_aux mod 2: INT & o_aux mod 2: NAT & o_aux: NAT & 2: NAT1 | o_aux:=o_aux mod 2);(o_aux = 0 ==> (IO_OFF: INT | o1:=IO_OFF) [] not(o_aux = 0) ==> (IO_ON: INT | o1:=IO_ON));(nn/4: INT & nn: INT & 4: INT & not(4 = 0) | o_aux:=nn/4);(o_aux mod 2: INT & o_aux mod 2: NAT & o_aux: NAT & 2: NAT1 | o_aux:=o_aux mod 2);(o_aux = 0 ==> (IO_OFF: INT | o2:=IO_OFF) [] not(o_aux = 0) ==> (IO_ON: INT | o2:=IO_ON))));
  ...
  List_Substitution(Implementation(logic_i),moveForward)==(board_0_O3,board_0_O2,board_0_O1 <-- nat_3_bits_to_bin_3_bits(l_linear));
  List_Substitution(Implementation(logic_i),turn)==(board_0_O6,board_0_O5,board_0_O4 <-- nat_3_bits_to_bin_3_bits(l_angular));
  List_Substitution(Implementation(logic_i),state_machine)==(IF smstate = INIT THEN moveForward(lv);smstate:=EXEC_1 ELSIF smstate = EXEC_1 THEN VAR local_obstacle IN local_obstacle: (local_obstacle: uint8_t);local_obstacle <-- get_board_0_I1;IF local_obstacle = IO_ON THEN MBC <-- get_ms_tick;avoid;turn(av);smstate:=EXEC_2 ELSIF local_obstacle = IO_OFF THEN smstate:=EXEC_1 ELSE skip END END ELSIF smstate = EXEC_2 THEN VAR since_value IN since_value: (since_value: uint32_t);since_value <-- since(MBC);VAR pi_div_av IN pi_div_av: (pi_div_av: uint32_t);pi_div_av:=pi/av;IF since_value<pi_div_av THEN smstate:=EXEC_2 ELSIF pi_div_av<=since_value THEN moveForward(lv);smstate:=EXEC_1 ELSE skip END END END ELSE skip END);
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(logic_i)) == (? | ? | ? | ? | reset_outputs,avoid,since,nat_3_bits_to_bin_3_bits,moveForward,turn,state_machine,communication,infoNeighbours,user_logic,get_board_0_O1,get_board_0_O2,get_board_0_O3,get_board_0_O4,get_board_0_O5,get_board_0_O6,get_board_0_O7,get_board_0_O8,refinement_of_infoNeighbours,refinement_of_communication,refinement_of_state_machine,refinement_of_turn,refinement_of_moveForward,refinement_of_nat_3_bits_to_bin_3_bits,refinement_of_since,refinement_of_avoid,refinement_of_reset_outputs | ? | seen(Machine(g_types)),seen(Machine(g_operators)),seen(Machine(io_constants)),seen(Machine(lchip_interface)),seen(Machine(user_ctx)),seen(Machine(inputs)) | ? | logic_i);
  List_Of_HiddenCst_Ids(Implementation(logic_i)) == (? | ?);
  List_Of_VisibleCst_Ids(Implementation(logic_i)) == (?);
  List_Of_VisibleVar_Ids(Implementation(logic_i)) == (tick,s_tick_cycle,ms_tick_cycle,first_time,cycle_timer,MBC,smstate,board_0_O8,board_0_O7,board_0_O6,board_0_O5,board_0_O4,board_0_O3,board_0_O2,board_0_O1 | ?);
  ...
  List_Of_Ids(Machine(user_ctx)) == (cycle_unit,SimSMovement_cycle_def,av,lv,pi,zero,alpha,STATE,INIT,EXEC_1,EXEC_2 | ? | ? | ? | ? | ? | seen(Machine(g_types)) | ? | user_ctx);
...
THEORY ListLocalOperationsX IS
  List_Local_Operations(Implementation(logic_i))==(reset_outputs,avoid,since,nat_3_bits_to_bin_3_bits,moveForward,turn,state_machine,communication,infoNeighbours)
END
&
...
THEORY ListLocalPreconditionX IS
  ...
  List_Local_Precondition(Implementation(logic_i),nat_3_bits_to_bin_3_bits)==(nn: uint32_t & nn: 0..3 & o2: uint8_t & o1: uint8_t & o0: uint8_t);
...
THEORY ListLocalSubstitutionX IS
  ...
  Expanded_List_Local_Substitution(Implementation(logic_i),nat_3_bits_to_bin_3_bits)==(nn: uint32_t & nn: 0..3 & o2: uint8_t & o1: uint8_t & o0: uint8_t | @(o2$0).(o2$0: uint8_t ==> o2:=o2$0) || @(o1$0).(o1$0: uint8_t ==> o1:=o1$0) || @(o0$0).(o0$0: uint8_t ==> o0:=o0$0));
