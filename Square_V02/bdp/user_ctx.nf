...
&
THEORY ListSetsX IS
  Set_Definition(Machine(user_ctx),STATE)==({NONE,SMovingForward,SObserving,DObserving,STurning,DTurning,Waiting,EObserving,SCollision,Final});
