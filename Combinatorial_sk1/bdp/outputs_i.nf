...
THEORY ListSeenInfoX IS
  ...
  Seen_Expanded_List_Substitution(Implementation(outputs_i),user_logic)==(@(board_0_O1$0).(board_0_O1$0: uint8_t ==> board_0_O1:=board_0_O1$0) || @(board_0_O2$0).(board_0_O2$0: uint8_t ==> board_0_O2:=board_0_O2$0) || @(board_0_O3$0).(board_0_O3$0: uint8_t ==> board_0_O3:=board_0_O3$0));
