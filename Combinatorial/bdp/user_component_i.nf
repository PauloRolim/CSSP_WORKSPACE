...
THEORY ListConstantsX IS
  ...
  Inherited_List_Constants(Implementation(user_component_i))==(?);
...
THEORY ListPropertiesX IS
  ...
  Inherited_List_Properties(Implementation(user_component_i))==(btrue);
