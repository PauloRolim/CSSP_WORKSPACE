...
&
THEORY ListSeesX IS
  List_Sees(Machine(lchip_interface))==(g_types,user_configuration)
END
&
THEORY ListUsesX IS
...
THEORY ListInstanciatedParametersX IS
  ...
  List_Instanciated_Parameters(Machine(lchip_interface),Machine(user_configuration))==(?)
END
&
...
THEORY ListPreconditionX IS
  ...
  List_Precondition(Machine(lchip_interface),read_global_input)==(input_id: uint8_t & input_id<NB_INPUTS & state: uint8_t);
  List_Precondition(Machine(lchip_interface),write_global_output)==(output_id: uint8_t & output_id<NB_OUTPUTS & state: uint8_t);
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(lchip_interface),write_global_output)==(output_id: uint8_t & output_id<NB_OUTPUTS & state: uint8_t | skip);
  Expanded_List_Substitution(Machine(lchip_interface),read_global_input)==(input_id: uint8_t & input_id<NB_INPUTS & state: uint8_t | @(state$0).(state$0: uint8_t ==> state:=state$0));
...
THEORY ListSeenInfoX IS
  Seen_Internal_List_Operations(Machine(lchip_interface),Machine(user_configuration))==(?);
  ...
  Seen_List_Operations(Machine(lchip_interface),Machine(user_configuration))==(?);
  Seen_Expanded_List_Invariant(Machine(lchip_interface),Machine(user_configuration))==(btrue);
