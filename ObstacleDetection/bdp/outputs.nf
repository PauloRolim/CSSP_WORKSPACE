...
THEORY ListInvariantX IS
  ...
  Context_List_Invariant(Machine(outputs))==(o_MovementI_move: uint8_t & o_MovementI_move_lv_0: uint8_t & o_MovementI_move_lv_1: uint8_t & o_MovementI_move_lv_2: uint8_t & o_MovementI_move_av_0: uint8_t & o_MovementI_move_av_1: uint8_t & o_MovementI_move_av_2: uint8_t & o_MovementI_stop: uint8_t);
...
THEORY ListSeenInfoX IS
  Seen_Internal_List_Operations(Machine(outputs),Machine(logic))==(user_logic,get_o_MovementI_move,get_o_MovementI_move_lv_0,get_o_MovementI_move_lv_1,get_o_MovementI_move_lv_2,get_o_MovementI_move_av_0,get_o_MovementI_move_av_1,get_o_MovementI_move_av_2,get_o_MovementI_stop);
  ...
  Seen_List_Precondition(Machine(outputs),get_o_MovementI_stop)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Machine(outputs),get_o_MovementI_stop)==(po:=o_MovementI_stop);
  Seen_List_Precondition(Machine(outputs),get_o_MovementI_move_av_2)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Machine(outputs),get_o_MovementI_move_av_2)==(po:=o_MovementI_move_av_2);
  Seen_List_Precondition(Machine(outputs),get_o_MovementI_move_av_1)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Machine(outputs),get_o_MovementI_move_av_1)==(po:=o_MovementI_move_av_1);
  Seen_List_Precondition(Machine(outputs),get_o_MovementI_move_av_0)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Machine(outputs),get_o_MovementI_move_av_0)==(po:=o_MovementI_move_av_0);
  Seen_List_Precondition(Machine(outputs),get_o_MovementI_move_lv_2)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Machine(outputs),get_o_MovementI_move_lv_2)==(po:=o_MovementI_move_lv_2);
  Seen_List_Precondition(Machine(outputs),get_o_MovementI_move_lv_1)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Machine(outputs),get_o_MovementI_move_lv_1)==(po:=o_MovementI_move_lv_1);
  Seen_List_Precondition(Machine(outputs),get_o_MovementI_move_lv_0)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Machine(outputs),get_o_MovementI_move_lv_0)==(po:=o_MovementI_move_lv_0);
  Seen_List_Precondition(Machine(outputs),get_o_MovementI_move)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Machine(outputs),get_o_MovementI_move)==(po:=o_MovementI_move);
  Seen_List_Precondition(Machine(outputs),user_logic)==(btrue);
  Seen_Expanded_List_Substitution(Machine(outputs),user_logic)==(@(o_MovementI_move$0).(o_MovementI_move$0: uint8_t ==> o_MovementI_move:=o_MovementI_move$0) || @(o_MovementI_move_lv_0$0).(o_MovementI_move_lv_0$0: uint8_t ==> o_MovementI_move_lv_0:=o_MovementI_move_lv_0$0) || @(o_MovementI_move_lv_1$0).(o_MovementI_move_lv_1$0: uint8_t ==> o_MovementI_move_lv_1:=o_MovementI_move_lv_1$0) || @(o_MovementI_move_lv_2$0).(o_MovementI_move_lv_2$0: uint8_t ==> o_MovementI_move_lv_2:=o_MovementI_move_lv_2$0) || @(o_MovementI_move_av_0$0).(o_MovementI_move_av_0$0: uint8_t ==> o_MovementI_move_av_0:=o_MovementI_move_av_0$0) || @(o_MovementI_move_av_1$0).(o_MovementI_move_av_1$0: uint8_t ==> o_MovementI_move_av_1:=o_MovementI_move_av_1$0) || @(o_MovementI_move_av_2$0).(o_MovementI_move_av_2$0: uint8_t ==> o_MovementI_move_av_2:=o_MovementI_move_av_2$0) || @(o_MovementI_stop$0).(o_MovementI_stop$0: uint8_t ==> o_MovementI_stop:=o_MovementI_stop$0));
  Seen_List_Operations(Machine(outputs),Machine(logic))==(user_logic,get_o_MovementI_move,get_o_MovementI_move_lv_0,get_o_MovementI_move_lv_1,get_o_MovementI_move_lv_2,get_o_MovementI_move_av_0,get_o_MovementI_move_av_1,get_o_MovementI_move_av_2,get_o_MovementI_stop);
  Seen_Expanded_List_Invariant(Machine(outputs),Machine(logic))==(btrue);
  Set_Definition(Machine(outputs),STATE)==({INIT,EXEC_1,EXEC_2})
END
&
