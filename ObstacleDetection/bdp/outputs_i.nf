...
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Implementation(outputs_i),write_outputs)==(btrue | @lsb.(@(lsb$2).(lsb$2: uint8_t ==> lsb:=lsb$2);(lsb: uint8_t | lsb:=o_MovementI_move);(0: uint8_t & 0<NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_lv_0);(1: uint8_t & 1<NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_lv_1);(2: uint8_t & 2<NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_lv_2);(3: uint8_t & 3<NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_av_0);(4: uint8_t & 4<NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_av_1);(5: uint8_t & 5<NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_av_2);(6: uint8_t & 6<NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_stop);(7: uint8_t & 7<NB_OUTPUTS & lsb: uint8_t | skip)));
