...
volatile const struct_constants SECTION_C4B_GLOBAL_CONSTANTS global_constants = {
	...
	.co_input_module_ids = {0,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255},
	.co_input_local_ids = {0,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255},
	.co_output_module_ids = {0,0,0,0,0,0,0,0},
	.co_output_local_ids = {0,1,2,3,4,5,6,7},
	.co_cycle_unit = cycle_unit,
	.co_SimSMovement_cycle_def = SimSMovement_cycle_def,
	.co_av = av,
	.co_lv = lv,
	.co_pi = pi,
};
