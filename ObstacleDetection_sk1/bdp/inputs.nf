...
THEORY ListVariablesX IS
  ...
  Local_List_Variables(Machine(inputs))==(i_ObstacleI_obstacle);
  List_Variables(Machine(inputs))==(i_ObstacleI_obstacle);
  External_List_Variables(Machine(inputs))==(i_ObstacleI_obstacle)
END
&
...
THEORY ListInvariantX IS
  ...
  List_Invariant(Machine(inputs))==(i_ObstacleI_obstacle: uint8_t)
END
&
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Machine(inputs))==(@(i_ObstacleI_obstacle$0).(i_ObstacleI_obstacle$0: uint8_t ==> i_ObstacleI_obstacle:=i_ObstacleI_obstacle$0));
  Context_List_Initialisation(Machine(inputs))==(skip);
  List_Initialisation(Machine(inputs))==(i_ObstacleI_obstacle:: uint8_t)
END
&
...
THEORY ListOperationsX IS
  Internal_List_Operations(Machine(inputs))==(read_inputs,get_i_ObstacleI_obstacle);
  List_Operations(Machine(inputs))==(read_inputs,get_i_ObstacleI_obstacle)
END
&
THEORY ListInputX IS
  List_Input(Machine(inputs),read_inputs)==(?);
  List_Input(Machine(inputs),get_i_ObstacleI_obstacle)==(?)
END
&
THEORY ListOutputX IS
  List_Output(Machine(inputs),read_inputs)==(?);
  List_Output(Machine(inputs),get_i_ObstacleI_obstacle)==(po)
END
&
THEORY ListHeaderX IS
  List_Header(Machine(inputs),read_inputs)==(read_inputs);
  List_Header(Machine(inputs),get_i_ObstacleI_obstacle)==(po <-- get_i_ObstacleI_obstacle)
END
&
...
THEORY ListPreconditionX IS
  ...
  List_Precondition(Machine(inputs),get_i_ObstacleI_obstacle)==(po: uint8_t)
END
&
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Machine(inputs),get_i_ObstacleI_obstacle)==(po: uint8_t | po:=i_ObstacleI_obstacle);
  Expanded_List_Substitution(Machine(inputs),read_inputs)==(btrue | @(i_ObstacleI_obstacle$0).(i_ObstacleI_obstacle$0: uint8_t ==> i_ObstacleI_obstacle:=i_ObstacleI_obstacle$0));
  List_Substitution(Machine(inputs),read_inputs)==(i_ObstacleI_obstacle:: uint8_t);
  List_Substitution(Machine(inputs),get_i_ObstacleI_obstacle)==(po:=i_ObstacleI_obstacle)
END
&
...
THEORY ListANYVarX IS
  ...
  List_ANY_Var(Machine(inputs),get_i_ObstacleI_obstacle)==(?)
END
&
THEORY ListOfIdsX IS
  List_Of_Ids(Machine(inputs)) == (? | ? | i_ObstacleI_obstacle | ? | read_inputs,get_i_ObstacleI_obstacle | ? | seen(Machine(g_types)) | ? | inputs);
...
THEORY VariablesEnvX IS
  Variables(Machine(inputs)) == (Type(i_ObstacleI_obstacle) == Mvl(btype(INTEGER,?,?)))
END
&
THEORY OperationsEnvX IS
  Operations(Machine(inputs)) == (Type(get_i_ObstacleI_obstacle) == Cst(btype(INTEGER,?,?),No_type);Type(read_inputs) == Cst(No_type,No_type));
  Observers(Machine(inputs)) == (Type(get_i_ObstacleI_obstacle) == Cst(btype(INTEGER,?,?),No_type))
END
&
THEORY TCIntRdX IS
