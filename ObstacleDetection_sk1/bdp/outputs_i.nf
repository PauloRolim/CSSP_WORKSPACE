...
THEORY ListInvariantX IS
  ...
  Context_List_Invariant(Implementation(outputs_i))==(ms_tick: uint32_t & o_MovementI_move: uint8_t & o_MovementI_move_lv_0: uint8_t & o_MovementI_move_lv_1: uint8_t & o_MovementI_move_lv_2: uint8_t & o_MovementI_move_av_0: uint8_t & o_MovementI_move_av_1: uint8_t & o_MovementI_move_av_2: uint8_t & o_MovementI_stop: uint8_t);
...
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Implementation(outputs_i),write_outputs)==(btrue | @lsb.(@(lsb$2).(lsb$2: uint8_t ==> lsb:=lsb$2);(lsb: uint8_t | lsb:=o_MovementI_move);(0: uint8_t & 0<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_lv_0);(1: uint8_t & 1<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_lv_1);(2: uint8_t & 2<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_lv_2);(3: uint8_t & 3<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_av_0);(4: uint8_t & 4<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_av_1);(5: uint8_t & 5<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_move_av_2);(6: uint8_t & 6<MAX_NB_OUTPUTS & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=o_MovementI_stop);(7: uint8_t & 7<MAX_NB_OUTPUTS & lsb: uint8_t | skip)));
  List_Substitution(Implementation(outputs_i),write_outputs)==(VAR lsb IN lsb: (lsb: uint8_t);lsb <-- get_o_MovementI_move;write_global_output(0,lsb);lsb <-- get_o_MovementI_move_lv_0;write_global_output(1,lsb);lsb <-- get_o_MovementI_move_lv_1;write_global_output(2,lsb);lsb <-- get_o_MovementI_move_lv_2;write_global_output(3,lsb);lsb <-- get_o_MovementI_move_av_0;write_global_output(4,lsb);lsb <-- get_o_MovementI_move_av_1;write_global_output(5,lsb);lsb <-- get_o_MovementI_move_av_2;write_global_output(6,lsb);lsb <-- get_o_MovementI_stop;write_global_output(7,lsb) END)
END
&
...
THEORY ListSeenInfoX IS
  Seen_Internal_List_Operations(Implementation(outputs_i),Machine(logic))==(user_logic,get_o_MovementI_move,get_o_MovementI_move_lv_0,get_o_MovementI_move_lv_1,get_o_MovementI_move_lv_2,get_o_MovementI_move_av_0,get_o_MovementI_move_av_1,get_o_MovementI_move_av_2,get_o_MovementI_stop);
  ...
  Seen_List_Precondition(Implementation(outputs_i),get_o_MovementI_stop)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Implementation(outputs_i),get_o_MovementI_stop)==(po:=o_MovementI_stop);
  Seen_List_Precondition(Implementation(outputs_i),get_o_MovementI_move_av_2)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Implementation(outputs_i),get_o_MovementI_move_av_2)==(po:=o_MovementI_move_av_2);
  Seen_List_Precondition(Implementation(outputs_i),get_o_MovementI_move_av_1)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Implementation(outputs_i),get_o_MovementI_move_av_1)==(po:=o_MovementI_move_av_1);
  Seen_List_Precondition(Implementation(outputs_i),get_o_MovementI_move_av_0)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Implementation(outputs_i),get_o_MovementI_move_av_0)==(po:=o_MovementI_move_av_0);
  Seen_List_Precondition(Implementation(outputs_i),get_o_MovementI_move_lv_2)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Implementation(outputs_i),get_o_MovementI_move_lv_2)==(po:=o_MovementI_move_lv_2);
  Seen_List_Precondition(Implementation(outputs_i),get_o_MovementI_move_lv_1)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Implementation(outputs_i),get_o_MovementI_move_lv_1)==(po:=o_MovementI_move_lv_1);
  Seen_List_Precondition(Implementation(outputs_i),get_o_MovementI_move_lv_0)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Implementation(outputs_i),get_o_MovementI_move_lv_0)==(po:=o_MovementI_move_lv_0);
  Seen_List_Precondition(Implementation(outputs_i),get_o_MovementI_move)==(po: uint8_t);
  Seen_Expanded_List_Substitution(Implementation(outputs_i),get_o_MovementI_move)==(po:=o_MovementI_move);
  Seen_List_Precondition(Implementation(outputs_i),user_logic)==(btrue);
  Seen_Expanded_List_Substitution(Implementation(outputs_i),user_logic)==(@(o_MovementI_move$0).(o_MovementI_move$0: uint8_t ==> o_MovementI_move:=o_MovementI_move$0) || @(o_MovementI_move_lv_0$0).(o_MovementI_move_lv_0$0: uint8_t ==> o_MovementI_move_lv_0:=o_MovementI_move_lv_0$0) || @(o_MovementI_move_lv_1$0).(o_MovementI_move_lv_1$0: uint8_t ==> o_MovementI_move_lv_1:=o_MovementI_move_lv_1$0) || @(o_MovementI_move_lv_2$0).(o_MovementI_move_lv_2$0: uint8_t ==> o_MovementI_move_lv_2:=o_MovementI_move_lv_2$0) || @(o_MovementI_move_av_0$0).(o_MovementI_move_av_0$0: uint8_t ==> o_MovementI_move_av_0:=o_MovementI_move_av_0$0) || @(o_MovementI_move_av_1$0).(o_MovementI_move_av_1$0: uint8_t ==> o_MovementI_move_av_1:=o_MovementI_move_av_1$0) || @(o_MovementI_move_av_2$0).(o_MovementI_move_av_2$0: uint8_t ==> o_MovementI_move_av_2:=o_MovementI_move_av_2$0) || @(o_MovementI_stop$0).(o_MovementI_stop$0: uint8_t ==> o_MovementI_stop:=o_MovementI_stop$0));
  Seen_List_Operations(Implementation(outputs_i),Machine(logic))==(user_logic,get_o_MovementI_move,get_o_MovementI_move_lv_0,get_o_MovementI_move_lv_1,get_o_MovementI_move_lv_2,get_o_MovementI_move_av_0,get_o_MovementI_move_av_1,get_o_MovementI_move_av_2,get_o_MovementI_stop);
...
THEORY ListIncludedOperationsX IS
  List_Included_Operations(Implementation(outputs_i),Machine(logic))==(user_logic,get_o_MovementI_move,get_o_MovementI_move_lv_0,get_o_MovementI_move_lv_1,get_o_MovementI_move_lv_2,get_o_MovementI_move_av_0,get_o_MovementI_move_av_1,get_o_MovementI_move_av_2,get_o_MovementI_stop);
