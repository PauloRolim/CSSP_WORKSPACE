...
THEORY ListVariablesX IS
  ...
  List_Variables(Implementation(user_component_i))==(I3,I2,I1,O2,O1);
  External_List_Variables(Implementation(user_component_i))==(I3,I2,I1,O2,O1)
END
&
...
THEORY ListInvariantX IS
  ...
  Expanded_List_Invariant(Implementation(user_component_i))==(I1: uint8_t & I2: uint8_t & I3: uint8_t & O1: uint8_t & O2: uint8_t);
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Implementation(user_component_i))==(@(I1$0).(I1$0: uint8_t ==> I1:=I1$0) || @(I2$0).(I2$0: uint8_t ==> I2:=I2$0) || @(I3$0).(I3$0: uint8_t ==> I3:=I3$0);(@(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0));(0: INT | divergence_test_var:=0));
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(user_component_i),user_app)==(btrue | (0: INT | divergence_test_var:=0);(btrue | @(I1$0).(I1$0: uint8_t ==> I1:=I1$0) || @(I2$0).(I2$0: uint8_t ==> I2:=I2$0) || @(I3$0).(I3$0: uint8_t ==> I3:=I3$0));(btrue | @(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0));(btrue | skip));
...
THEORY ListConstantsX IS
  ...
  Inherited_List_Constants(Implementation(user_component_i))==(DELTA_T);
...
THEORY ListPropertiesX IS
  ...
  Inherited_List_Properties(Implementation(user_component_i))==(DELTA_T: uint32_t);
...
THEORY ListIncludedOperationsX IS
  ...
  List_Included_Operations(Implementation(user_component_i),Machine(logic))==(user_logic,get_O1,get_O2);
  List_Included_Operations(Implementation(user_component_i),Machine(inputs))==(read_inputs,get_I1,get_I2,get_I3)
END
&
...
THEORY ListVisibleStaticX IS
  List_Constants(Implementation(user_component_i),Machine(user_ctx))==(DELTA_T);
  List_Constants_Env(Implementation(user_component_i),Machine(user_ctx))==(Type(DELTA_T) == Cst(btype(INTEGER,?,?)));
...
THEORY ListOfIdsX IS
  ...
  List_Of_Ids(Machine(logic)) == (? | ? | O2,O1 | ? | user_logic,get_O1,get_O2 | ? | seen(Machine(g_types)),seen(Machine(g_operators)),seen(Machine(io_constants)),seen(Machine(lchip_interface)),seen(Machine(user_ctx)) | ? | logic);
  ...
  List_Of_Ids(Machine(user_ctx)) == (DELTA_T | ? | ? | ? | ? | ? | seen(Machine(g_types)) | ? | user_ctx);
  List_Of_HiddenCst_Ids(Machine(user_ctx)) == (? | ?);
  List_Of_VisibleCst_Ids(Machine(user_ctx)) == (DELTA_T);
...
THEORY ConstantsEnvX IS
  Constants(Implementation(user_component_i)) == (Type(DELTA_T) == Cst(btype(INTEGER,?,?)))
END
&
...
THEORY ImportedVariablesListX IS
  ...
  ImportedVariablesList(Implementation(user_component_i),Machine(inputs))==(I3,I2,I1);
  ImportedVisVariablesList(Implementation(user_component_i),Machine(inputs))==(?);
  ImportedVariablesList(Implementation(user_component_i),Machine(logic))==(O2,O1);
