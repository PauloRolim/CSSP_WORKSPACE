...
&
THEORY ListSeesX IS
  List_Sees(Machine(lchip_interface))==(g_types)
END
&
THEORY ListUsesX IS
...
THEORY ListVariablesX IS
  ...
  Local_List_Variables(Machine(lchip_interface))==(?);
  List_Variables(Machine(lchip_interface))==(?);
  External_List_Variables(Machine(lchip_interface))==(?)
END
&
...
THEORY ListInvariantX IS
  ...
  List_Invariant(Machine(lchip_interface))==(btrue)
END
&
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Machine(lchip_interface))==(skip);
  Context_List_Initialisation(Machine(lchip_interface))==(skip);
  List_Initialisation(Machine(lchip_interface))==(skip)
END
&
...
THEORY ListPreconditionX IS
  ...
  List_Precondition(Machine(lchip_interface),read_global_input)==(input_id: uint8_t & state: uint8_t);
  List_Precondition(Machine(lchip_interface),write_global_output)==(output_id: uint8_t & state: uint8_t);
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(lchip_interface),get_ms_tick)==(out: uint32_t | @(out$0).(out$0: uint32_t ==> out:=out$0));
  ...
  Expanded_List_Substitution(Machine(lchip_interface),write_global_output)==(output_id: uint8_t & state: uint8_t | skip);
  Expanded_List_Substitution(Machine(lchip_interface),read_global_input)==(input_id: uint8_t & state: uint8_t | @(state$0).(state$0: uint8_t ==> state:=state$0));
  ...
  List_Substitution(Machine(lchip_interface),get_ms_tick)==(out:: uint32_t);
...
THEORY ListSeenInfoX IS
  ...
  Seen_Context_List_Assertions(Machine(lchip_interface))==(btrue);
  Seen_Context_List_Properties(Machine(lchip_interface))==(btrue);
