...
THEORY ListInvariantX IS
  ...
  Context_List_Invariant(Implementation(outputs_i))==(O1: uint8_t & O2: uint8_t);
...
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Implementation(outputs_i),write_outputs)==(btrue | @lsb.(@(lsb$2).(lsb$2: uint8_t ==> lsb:=lsb$2);(lsb: uint8_t | lsb:=O1);(0: uint8_t & lsb: uint8_t | skip);(lsb: uint8_t | lsb:=O2);(1: uint8_t & lsb: uint8_t | skip)));
  List_Substitution(Implementation(outputs_i),write_outputs)==(VAR lsb IN lsb: (lsb: uint8_t);lsb <-- get_O1;write_global_output(0,lsb);lsb <-- get_O2;write_global_output(1,lsb) END)
END
&
...
THEORY ListSeenInfoX IS
  ...
  Seen_Context_List_Invariant(Implementation(outputs_i))==(btrue);
  ...
  Seen_Internal_List_Operations(Implementation(outputs_i),Machine(logic))==(user_logic,get_O1,get_O2);
  ...
  Seen_Expanded_List_Substitution(Implementation(outputs_i),user_logic)==(@(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0));
  Seen_List_Operations(Implementation(outputs_i),Machine(logic))==(user_logic,get_O1,get_O2);
  ...
  Seen_Expanded_List_Substitution(Implementation(outputs_i),get_ms_tick)==(@(out$0).(out$0: uint32_t ==> out:=out$0));
  ...
  Seen_List_Precondition(Implementation(outputs_i),write_global_output)==(output_id: uint8_t & state: uint8_t);
  Seen_Expanded_List_Substitution(Implementation(outputs_i),write_global_output)==(skip);
  Seen_List_Precondition(Implementation(outputs_i),read_global_input)==(input_id: uint8_t & state: uint8_t);
...
THEORY ListIncludedOperationsX IS
  List_Included_Operations(Implementation(outputs_i),Machine(logic))==(user_logic,get_O1,get_O2);
