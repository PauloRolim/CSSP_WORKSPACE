...
THEORY ListConstantsX IS
  List_Valuable_Constants(Implementation(user_ctx_i))==(DELTA_T);
  Inherited_List_Constants(Implementation(user_ctx_i))==(DELTA_T);
...
THEORY ListPropertiesX IS
  Abstract_List_Properties(Implementation(user_ctx_i))==(DELTA_T: uint32_t);
...
THEORY ListValuesX IS
  ...
  Values_Subs(Implementation(user_ctx_i))==(DELTA_T: 1000);
  List_Values(Implementation(user_ctx_i))==(DELTA_T = 1000)
END
&
...
THEORY InheritedEnvX IS
  Constants(Implementation(user_ctx_i))==(Type(DELTA_T) == Cst(btype(INTEGER,?,?)))
END
&
