...
THEORY ListSeenInfoX IS
  ...
  Seen_Expanded_List_Substitution(Implementation(outputs_i),user_logic)==(@(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0) || @(O3$0).(O3$0: uint8_t ==> O3:=O3$0) || @(O4$0).(O4$0: uint8_t ==> O4:=O4$0) || @(O5$0).(O5$0: uint8_t ==> O5:=O5$0) || @(O6$0).(O6$0: uint8_t ==> O6:=O6$0) || @(O7$0).(O7$0: uint8_t ==> O7:=O7$0) || @(O8$0).(O8$0: uint8_t ==> O8:=O8$0));
