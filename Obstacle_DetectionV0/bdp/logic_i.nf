...
THEORY ListOperationsX IS
  Internal_List_Operations(Implementation(logic_i))==(reset_outputs,stop,move,nat_3_bits_to_bin_3_bits,since,state_machine,communication,user_logic,get_O1,get_O2,get_O3,get_O4,get_O5,get_O6,get_O7,get_O8);
  List_Operations(Implementation(logic_i))==(reset_outputs,stop,move,nat_3_bits_to_bin_3_bits,since,state_machine,communication,user_logic,get_O1,get_O2,get_O3,get_O4,get_O5,get_O6,get_O7,get_O8)
END
&
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(logic_i),state_machine)==(MBC: uint32_t & smstate: STATE & cycle_timer: uint32_t & lv: uint32_t & lv: 0..7 & av: uint32_t & av: 0..7 & O1: uint8_t & O2: uint8_t & O3: uint8_t & O4: uint8_t & O5: uint8_t & O6: uint8_t & O7: uint8_t & O8: uint8_t | smstate = INIT ==> ((lv: uint32_t & lv: 0..7 & 0: uint32_t & 0: 0..7 | @(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0) || @(O3$0).(O3$0: uint8_t ==> O3:=O3$0) || @(O4$0).(O4$0: uint8_t ==> O4:=O4$0) || @(O5$0).(O5$0: uint8_t ==> O5:=O5$0) || @(O6$0).(O6$0: uint8_t ==> O6:=O6$0) || @(O7$0).(O7$0: uint8_t ==> O7:=O7$0));(ms_tick_cycle: uint32_t & s_tick_cycle: uint32_t & tick: uint32_t | @(ms_tick_cycle$0).(ms_tick_cycle$0: uint32_t ==> ms_tick_cycle:=ms_tick_cycle$0) || @(s_tick_cycle$0).(s_tick_cycle$0: uint32_t ==> s_tick_cycle:=s_tick_cycle$0) || @(tick$0).(tick$0: uint32_t ==> tick:=tick$0));smstate:=EXEC_1) [] not(smstate = INIT) ==> (smstate = EXEC_1 ==> @local_obstacle.(@(local_obstacle$2).(local_obstacle$2: uint8_t ==> local_obstacle:=local_obstacle$2);(local_obstacle: uint8_t | local_obstacle:=I1);(local_obstacle = IO_ON ==> ((MBC: uint32_t | MBC:=ms_tick);(btrue | @(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0) || @(O3$0).(O3$0: uint8_t ==> O3:=O3$0) || @(O4$0).(O4$0: uint8_t ==> O4:=O4$0) || @(O5$0).(O5$0: uint8_t ==> O5:=O5$0) || @(O6$0).(O6$0: uint8_t ==> O6:=O6$0) || @(O7$0).(O7$0: uint8_t ==> O7:=O7$0));(0: uint32_t & 0: 0..7 & av: uint32_t & av: 0..7 | @(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0) || @(O3$0).(O3$0: uint8_t ==> O3:=O3$0) || @(O4$0).(O4$0: uint8_t ==> O4:=O4$0) || @(O5$0).(O5$0: uint8_t ==> O5:=O5$0) || @(O6$0).(O6$0: uint8_t ==> O6:=O6$0) || @(O7$0).(O7$0: uint8_t ==> O7:=O7$0));(ms_tick_cycle: uint32_t & s_tick_cycle: uint32_t & tick: uint32_t | @(ms_tick_cycle$0).(ms_tick_cycle$0: uint32_t ==> ms_tick_cycle:=ms_tick_cycle$0) || @(s_tick_cycle$0).(s_tick_cycle$0: uint32_t ==> s_tick_cycle:=s_tick_cycle$0) || @(tick$0).(tick$0: uint32_t ==> tick:=tick$0));smstate:=EXEC_2) [] not(local_obstacle = IO_ON) ==> (local_obstacle = IO_OFF ==> smstate:=EXEC_1 [] not(local_obstacle = IO_OFF) ==> (ms_tick_cycle: uint32_t & s_tick_cycle: uint32_t & tick: uint32_t | @(ms_tick_cycle$0).(ms_tick_cycle$0: uint32_t ==> ms_tick_cycle:=ms_tick_cycle$0) || @(s_tick_cycle$0).(s_tick_cycle$0: uint32_t ==> s_tick_cycle:=s_tick_cycle$0) || @(tick$0).(tick$0: uint32_t ==> tick:=tick$0))))) [] not(smstate = EXEC_1) ==> (smstate = EXEC_2 ==> @since_value.(@(since_value$2).(since_value$2: uint32_t ==> since_value:=since_value$2);(MBC: uint32_t & since_value: uint32_t | @(elapsed$0).(elapsed$0: uint32_t ==> since_value:=elapsed$0));@pi_div_av.(@(pi_div_av$2).(pi_div_av$2: uint32_t ==> pi_div_av:=pi_div_av$2);(pi/av: INT & pi: INT & av: INT & not(av = 0) | pi_div_av:=pi/av);(since_value<pi_div_av ==> smstate:=EXEC_2 [] not(since_value<pi_div_av) ==> (pi_div_av<=since_value ==> ((lv: uint32_t & lv: 0..7 & 0: uint32_t & 0: 0..7 | @(O1$0).(O1$0: uint8_t ==> O1:=O1$0) || @(O2$0).(O2$0: uint8_t ==> O2:=O2$0) || @(O3$0).(O3$0: uint8_t ==> O3:=O3$0) || @(O4$0).(O4$0: uint8_t ==> O4:=O4$0) || @(O5$0).(O5$0: uint8_t ==> O5:=O5$0) || @(O6$0).(O6$0: uint8_t ==> O6:=O6$0) || @(O7$0).(O7$0: uint8_t ==> O7:=O7$0));(ms_tick_cycle: uint32_t & s_tick_cycle: uint32_t & tick: uint32_t | @(ms_tick_cycle$0).(ms_tick_cycle$0: uint32_t ==> ms_tick_cycle:=ms_tick_cycle$0) || @(s_tick_cycle$0).(s_tick_cycle$0: uint32_t ==> s_tick_cycle:=s_tick_cycle$0) || @(tick$0).(tick$0: uint32_t ==> tick:=tick$0));smstate:=EXEC_1) [] not(pi_div_av<=since_value) ==> (ms_tick_cycle: uint32_t & s_tick_cycle: uint32_t & tick: uint32_t | @(ms_tick_cycle$0).(ms_tick_cycle$0: uint32_t ==> ms_tick_cycle:=ms_tick_cycle$0) || @(s_tick_cycle$0).(s_tick_cycle$0: uint32_t ==> s_tick_cycle:=s_tick_cycle$0) || @(tick$0).(tick$0: uint32_t ==> tick:=tick$0)))))) [] not(smstate = EXEC_2) ==> skip)));
  ...
  List_Substitution(Implementation(logic_i),state_machine)==(IF smstate = INIT THEN move(lv,0);communication;smstate:=EXEC_1 ELSIF smstate = EXEC_1 THEN VAR local_obstacle IN local_obstacle: (local_obstacle: uint8_t);local_obstacle <-- get_I1;IF local_obstacle = IO_ON THEN MBC <-- get_ms_tick;stop;move(0,av);communication;smstate:=EXEC_2 ELSIF local_obstacle = IO_OFF THEN smstate:=EXEC_1 ELSE communication END END ELSIF smstate = EXEC_2 THEN VAR since_value IN since_value: (since_value: uint32_t);since_value <-- since(MBC);VAR pi_div_av IN pi_div_av: (pi_div_av: uint32_t);pi_div_av:=pi/av;IF since_value<pi_div_av THEN smstate:=EXEC_2 ELSIF pi_div_av<=since_value THEN move(lv,0);communication;smstate:=EXEC_1 ELSE communication END END END ELSE skip END);
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(logic_i)) == (? | ? | ? | ? | reset_outputs,stop,move,nat_3_bits_to_bin_3_bits,since,state_machine,communication,user_logic,get_O1,get_O2,get_O3,get_O4,get_O5,get_O6,get_O7,get_O8,refinement_of_communication,refinement_of_state_machine,refinement_of_since,refinement_of_nat_3_bits_to_bin_3_bits,refinement_of_stop,refinement_of_move,refinement_of_reset_outputs | ? | seen(Machine(g_types)),seen(Machine(g_operators)),seen(Machine(io_constants)),seen(Machine(lchip_interface)),seen(Machine(user_ctx)),seen(Machine(inputs)) | ? | logic_i);
